...
{
    /// <summary>
    /// CrmOpportunityPut200ResponseOpportunityListInnerLinesInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="CrmOpportunityPut200ResponseOpportunityListInnerLinesInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "crmOpportunity_put_200_response_opportunityList_inner_Lines_inner")]
    public partial class CrmOpportunityPut200ResponseOpportunityListInnerLinesInner(string comment = default, decimal discount = default, string iD = default, decimal price = default, string productID = default, string productName = default, string productSku = default, decimal quantity = default, decimal tax = default, decimal taxPercent = default, string taxRule = default, decimal total = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrmOpportunityPut200ResponseOpportunityListInnerLinesInner {\n");
