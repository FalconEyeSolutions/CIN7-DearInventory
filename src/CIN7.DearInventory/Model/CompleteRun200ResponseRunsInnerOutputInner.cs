...
{
    /// <summary>
    /// CompleteRun200ResponseRunsInnerOutputInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="CompleteRun200ResponseRunsInnerOutputInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "Complete_Run_200_response_Runs_inner_Output_inner")]
    public partial class CompleteRun200ResponseRunsInnerOutputInner(string batchSN = default, string costingMethod = default, object expiryDate = default, string locationID = default, string locationName = default, string productCode = default, string productID = default, string productName = default, decimal quantity = default, bool received = default, string receivedDate = default, string unit = default, decimal unitCost = default, decimal wastageQuantity = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompleteRun200ResponseRunsInnerOutputInner {\n");
