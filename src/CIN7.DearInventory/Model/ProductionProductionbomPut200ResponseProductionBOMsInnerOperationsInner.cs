...
{
    /// <summary>
    /// ProductionProductionbomPut200ResponseProductionBOMsInnerOperationsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionProductionbomPut200ResponseProductionBOMsInnerOperationsInner" /> class.
    /// </remarks>
    ...
    public partial class ProductionProductionbomPut200ResponseProductionBOMsInnerOperationsInner(List<string> attachments = default, List<string> components = default, decimal cycleTime = default, List<string> finishedProducts = default, List<string> inputProducts = default, bool isDropShip = default, string name = default, List<string> notes = default, string operationID = default, List<ProductionProductionbomPutRequestOperationsInnerOperationLinksInner> operationLinks = default, string operationType = default, decimal order = default, List<string> outputProducts = default, List<ProductionProductionbomPutRequestOperationsInnerResourcesInner> resources = default, decimal unitsPerCycle = default, List<string> variationComponents = default, object workCenterCoManProcurementType = default, string workCenterID = default, string workCenterName = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionProductionbomPut200ResponseProductionBOMsInnerOperationsInner {\n");
