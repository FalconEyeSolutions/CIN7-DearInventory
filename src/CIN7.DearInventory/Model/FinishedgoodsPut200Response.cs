...
{
    /// <summary>
    /// FinishedgoodsPut200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="FinishedgoodsPut200Response" /> class.
    /// </remarks>
    ...
    public partial class FinishedgoodsPut200Response(string account = default, string assemblyInstructionURL = default, string assemblyNumber = default, string batchSN = default, object bin = default, object binID = default, string completionDate = default, string customField1 = default, string customField10 = default, string customField2 = default, string customField3 = default, string customField4 = default, string customField5 = default, string customField6 = default, string customField7 = default, string customField8 = default, string customField9 = default, List<string> errors = default, string expiryDate = default, string location = default, string locationID = default, object notes = default, List<FinishedgoodsPut200ResponseOrderLinesInner> orderLines = default, List<FinishedgoodsPut200ResponsePickLinesInner> pickLines = default, string productCode = default, string productID = default, string productName = default, decimal quantity = default, string status = default, string taskID = default, List<string> transactions = default, string wIPAccount = default, string wIPDate = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FinishedgoodsPut200Response {\n");
