...
{
    /// <summary>
    /// StocktakePut200ResponseZeroStockOnHandProductsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="StocktakePut200ResponseZeroStockOnHandProductsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "stocktake_put_200_response_ZeroStockOnHandProducts_inner")]
    public partial class StocktakePut200ResponseZeroStockOnHandProductsInner(string barcode = default, object batchSN = default, string comments = default, string costingMethod = default, string dimensionsUnits = default, object expiryDate = default, JournalPgLmtTaskidStsSrchGet200ResponseJournalsInnerAttachmentsInner image = default, string location = default, string locationID = default, string productCustomField1 = default, string productCustomField10 = default, string productCustomField2 = default, string productCustomField3 = default, string productCustomField4 = default, string productCustomField5 = default, string productCustomField6 = default, string productCustomField7 = default, string productCustomField8 = default, string productCustomField9 = default, decimal productHeight = default, string productID = default, decimal productLength = default, string productName = default, decimal productWeight = default, decimal productWidth = default, decimal quantity = default, string sKU = default, string stockLocator = default, string unit = default, decimal unitCost = default, string weightUnits = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StocktakePut200ResponseZeroStockOnHandProductsInner {\n");
