...
{
    /// <summary>
    /// FinishedgoodsPostRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="FinishedgoodsPostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "finishedgoods_post_request")]
    public partial class FinishedgoodsPostRequest(string account = default, string batchSN = default, string bin = default, string binID = default, string completionDate = default, string customField1 = default, string customField10 = default, string customField2 = default, string customField3 = default, string customField4 = default, string customField5 = default, string customField6 = default, string customField7 = default, string customField8 = default, string customField9 = default, string expiryDate = default, string location = default, string locationID = default, string notes = default, string productCode = default, string productID = default, string productName = default, decimal quantity = default, string status = default, string wIPAccount = default, string wIPDate = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FinishedgoodsPostRequest {\n");
