...
{
    /// <summary>
    /// AdvancedPurchaseIdVoidDelete200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="AdvancedPurchaseIdVoidDelete200Response" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "advancedPurchase_Id__Void__delete_200_response")]
    public partial class AdvancedPurchaseIdVoidDelete200Response(AdvancedPurchasePutRequestAdditionalAttributes additionalAttributes = default, string approach = default, List<string> attachments = default, string baseCurrency = default, AdvancedPurchasePut200ResponseBillingAddress billingAddress = default, bool blindReceipt = default, string combinedInvoiceStatus = default, string combinedPaymentStatus = default, string combinedReceivingStatus = default, string contact = default, List<AdvancedPurchasePut200ResponseCreditNoteInner> creditNote = default, decimal currencyRate = default, string iD = default, string inventoryAccount = default, List<string> inventoryMovements = default, List<AdvancedPurchasePut200ResponseInvoiceInner> invoice = default, bool isServiceOnly = default, string lastUpdatedDate = default, string location = default, List<AdvancedPurchasePut200ResponseManualJournalsInner> manualJournals = default, string note = default, AdvancedPurchasePut200ResponseOrder order = default, string orderDate = default, string orderNumber = default, string phone = default, List<AdvancedPurchasePut200ResponseManualJournalsInner> putAway = default, object relatedDropShipSaleTask = default, object requiredBy = default, AdvancedPurchasePut200ResponseShippingAddress shippingAddress = default, string status = default, List<AdvancedPurchasePut200ResponseManualJournalsInner> stockReceived = default, string supplier = default, string supplierCurrency = default, string supplierID = default, string taxCalculation = default, string taxRule = default, string terms = default, string type = default) : IValidatableObject
    {
        /// <summary>
        ...
        public AdvancedPurchasePut200ResponseBillingAddress BillingAddress { get; set; } = billingAddress;
        ...
        public List<AdvancedPurchasePut200ResponseCreditNoteInner> CreditNote { get; set; } = creditNote;
        ...
        public List<AdvancedPurchasePut200ResponseInvoiceInner> Invoice { get; set; } = invoice;
        ...
        public List<AdvancedPurchasePut200ResponseManualJournalsInner> ManualJournals { get; set; } = manualJournals;
        ...
        public AdvancedPurchasePut200ResponseOrder Order { get; set; } = order;
        ...
        public List<AdvancedPurchasePut200ResponseManualJournalsInner> PutAway { get; set; } = putAway;
        ...
        public List<AdvancedPurchasePut200ResponseManualJournalsInner> StockReceived { get; set; } = stockReceived;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchaseIdVoidDelete200Response {\n");
