...
{
    /// <summary>
    /// StartRunOperation200ResponseRunsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="StartRunOperation200ResponseRunsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "Start_Run_Operation_200_response_Runs_inner")]
    public partial class StartRunOperation200ResponseRunsInner(object dueDate = default, object endDate = default, decimal issueMethodParameter = default, List<string> manualJournals = default, decimal number = default, List<StartRunOperation200ResponseRunsInnerOperationsInner> operations = default, List<string> output = default, List<string> pendingOutput = default, decimal quantity = default, string receivedDate = default, string runID = default, string startDate = default, string status = default, string wIPAccount = default) : IValidatableObject
    {
        ...
        public List<StartRunOperation200ResponseRunsInnerOperationsInner> Operations { get; set; } = operations;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StartRunOperation200ResponseRunsInner {\n");
