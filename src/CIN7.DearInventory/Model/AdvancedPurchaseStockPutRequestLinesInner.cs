...
{
    /// <summary>
    /// AdvancedPurchaseStockPutRequestLinesInner
    /// </summary>
    [DataContract(Name = "advancedPurchaseStock_put_request_Lines_inner")]
    public partial class AdvancedPurchaseStockPutRequestLinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedPurchaseStockPutRequestLinesInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected AdvancedPurchaseStockPutRequestLinesInner()
        { }
        ...
        public AdvancedPurchaseStockPutRequestLinesInner(string batchSN = default, string date = default, string expiryDate = default, object location = default, object locationID = default, string name = default, string productID = default, decimal quantity = default, bool received = default, string sKU = default, string supplierSKU = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchaseStockPutRequestLinesInner {\n");
