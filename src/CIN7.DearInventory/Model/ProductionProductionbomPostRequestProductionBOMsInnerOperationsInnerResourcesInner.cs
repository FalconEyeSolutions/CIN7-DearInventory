...
{
    /// <summary>
    /// ProductionProductionbomPostRequestProductionBOMsInnerOperationsInnerResourcesInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionProductionbomPostRequestProductionBOMsInnerOperationsInnerResourcesInner" /> class.
    /// </remarks>
    ...
    public partial class ProductionProductionbomPostRequestProductionBOMsInnerOperationsInnerResourcesInner(decimal cost = default, string costCalculationType = default, decimal cycleTime = default, decimal position = default, decimal quantity = default, string resourceCode = default, string resourceID = default, string resourceName = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionProductionbomPostRequestProductionBOMsInnerOperationsInnerResourcesInner {\n");
