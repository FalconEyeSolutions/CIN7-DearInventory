...
{
    /// <summary>
    /// FinishedgoodsTaskidGet200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="FinishedgoodsTaskidGet200Response" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "finishedgoods_Taskid__get_200_response")]
    public partial class FinishedgoodsTaskidGet200Response(string account = default, string assemblyInstructionURL = default, string assemblyNumber = default, string batchSN = default, string bin = default, string binID = default, string completionDate = default, string customField1 = default, string customField10 = default, string customField2 = default, string customField3 = default, string customField4 = default, string customField5 = default, string customField6 = default, string customField7 = default, string customField8 = default, string customField9 = default, List<string> errors = default, string expiryDate = default, string location = default, string locationID = default, string notes = default, List<FinishedgoodsOrderPostRequestOrderLinesInner> orderLines = default, List<FinishedgoodsPickPostRequestPickLinesInner> pickLines = default, string productCode = default, string productID = default, string productName = default, decimal quantity = default, string status = default, string taskID = default, List<string> transactions = default, string wIPAccount = default, string wIPDate = default) : IValidatableObject
    {
        /// <summary>
        ...
        public List<FinishedgoodsOrderPostRequestOrderLinesInner> OrderLines { get; set; } = orderLines;

        /// <summary>
        /// Gets or Sets PickLines
        /// </summary>
        [DataMember(Name = "PickLines", EmitDefaultValue = false)]
        public List<FinishedgoodsPickPostRequestPickLinesInner> PickLines { get; set; } = pickLines;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FinishedgoodsTaskidGet200Response {\n");
