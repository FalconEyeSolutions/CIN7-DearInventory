...
{
    /// <summary>
    /// SupplierPut200ResponseSupplierListInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="SupplierPut200ResponseSupplierListInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "supplier_put_200_response_SupplierList_inner")]
    public partial class SupplierPut200ResponseSupplierListInner(string accountPayable = default, string additionalAttribute1 = default, string additionalAttribute10 = default, string additionalAttribute2 = default, string additionalAttribute3 = default, string additionalAttribute4 = default, string additionalAttribute5 = default, string additionalAttribute6 = default, string additionalAttribute7 = default, string additionalAttribute8 = default, string additionalAttribute9 = default, List<SupplierPut200ResponseSupplierListInnerAddressesInner> addresses = default, string attributeSet = default, string comments = default, List<SupplierPut200ResponseSupplierListInnerContactsInner> contacts = default, string currency = default, decimal discount = default, string iD = default, string lastModifiedOn = default, string name = default, string paymentTerm = default, string status = default, string taxNumber = default, string taxRule = default) : IValidatableObject
    {
        ...
        public List<SupplierPut200ResponseSupplierListInnerAddressesInner> Addresses { get; set; } = addresses;
        ...
        public List<SupplierPut200ResponseSupplierListInnerContactsInner> Contacts { get; set; } = contacts;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SupplierPut200ResponseSupplierListInner {\n");
