...
{
    /// <summary>
    /// StocktransferPutRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="StocktransferPutRequest" /> class.
    /// </remarks>
    ...
    public partial class StocktransferPutRequest(string completionDate = default, string costDistributionType = default, string departureDate = default, string from = default, string fromLocation = default, string inTransitAccount = default, List<StocktransferPutRequestLinesInner> lines = default, List<string> manualJournals = default, string reference = default, string requiredByDate = default, bool skipOrder = default, string status = default, string taskID = default, string to = default, string toLocation = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StocktransferPutRequest {\n");
