...
{
    /// <summary>
    /// BanktransferTaskidGet200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="BanktransferTaskidGet200Response" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "banktransfer_Taskid__get_200_response")]
    public partial class BanktransferTaskidGet200Response(List<string> attachments = default, decimal currencyConversionRate = default, string date = default, string fromAccount = default, decimal fromAmount = default, string note = default, string reference = default, string status = default, string taskID = default, string toAccount = default, decimal toAmount = default, List<BanktransferPut200ResponseTransactionsInner> transactions = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BanktransferTaskidGet200Response {\n");
