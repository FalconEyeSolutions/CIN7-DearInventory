...
{
    /// <summary>
    /// FinishedgoodsPickPostRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="FinishedgoodsPickPostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "finishedgoodsPick_post_request")]
    public partial class FinishedgoodsPickPostRequest(string account = default, string completionDate = default, List<FinishedgoodsPickPostRequestPickLinesInner> pickLines = default, string status = default, string taskID = default, string wIPAccount = default, string wIPDate = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FinishedgoodsPickPostRequest {\n");
