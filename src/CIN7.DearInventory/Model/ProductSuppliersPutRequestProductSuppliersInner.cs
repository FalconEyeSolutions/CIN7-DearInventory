...
{
    /// <summary>
    /// ProductSuppliersPutRequestProductSuppliersInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductSuppliersPutRequestProductSuppliersInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productSuppliers_put_request_ProductSuppliers_inner")]
    public partial class ProductSuppliersPutRequestProductSuppliersInner(decimal cost = default, string currency = default, bool dropShip = default, decimal fixedCost = default, string productID = default, object productSKU = default, string productSupplierID = default, List<ProductSuppliersPutRequestProductSuppliersInnerProductSupplierOptionsInner> productSupplierOptions = default, decimal purchaseCost = default, string supplierID = default, string supplierInventoryCode = default, object supplierName = default, string supplierProductName = default, string supplierProductURL = default) : IValidatableObject
    {
        ...
        public object ProductSKU { get; set; } = productSKU;
        ...
        public object SupplierName { get; set; } = supplierName;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductSuppliersPutRequestProductSuppliersInner {\n");
