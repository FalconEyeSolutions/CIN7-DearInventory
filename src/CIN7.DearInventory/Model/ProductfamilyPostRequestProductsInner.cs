...
{
    /// <summary>
    /// ProductfamilyPostRequestProductsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductfamilyPostRequestProductsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productfamily_post_request_Products_inner")]
    public partial class ProductfamilyPostRequestProductsInner(string iD = default, string name = default, string option1 = default, string option2 = default, string option3 = default, string sKU = default) : IValidatableObject
    {
        /// <summary>
        /// Gets or Sets ID
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductfamilyPostRequestProductsInner {\n");
