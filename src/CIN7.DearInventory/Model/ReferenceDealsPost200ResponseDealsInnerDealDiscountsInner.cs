...
{
    /// <summary>
    /// ReferenceDealsPost200ResponseDealsInnerDealDiscountsInner
    /// </summary>
    [DataContract(Name = "referenceDeals_post_200_response_Deals_inner_DealDiscounts_inner")]
    public partial class ReferenceDealsPost200ResponseDealsInnerDealDiscountsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferenceDealsPost200ResponseDealsInnerDealDiscountsInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected ReferenceDealsPost200ResponseDealsInnerDealDiscountsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferenceDealsPost200ResponseDealsInnerDealDiscountsInner" /> class.
        /// </summary>
        ...
        public ReferenceDealsPost200ResponseDealsInnerDealDiscountsInner(bool buyMore = default, string buyType = default, object buyValue = default, string buyValueType = default, List<ReferenceDealsPost200ResponseDealsInnerDealDiscountsInnerDealDiscountBrandsInner> dealDiscountBrands = default, List<ReferenceDealsPost200ResponseDealsInnerDealDiscountsInnerDealDiscountCategoriesInner> dealDiscountCategories = default, List<ReferenceDealsPost200ResponseDealsInnerDealDiscountsInnerDealDiscountProductsInner> dealDiscountProducts = default, List<ReferenceDealsPost200ResponseDealsInnerDealDiscountsInnerDealDiscountTagsInner> dealDiscountTags = default, string discountID = default, string discountName = default, string discountType = default, string getType = default, object getValue = default, string getValueType = default, string iD = default, bool isOrderLevel = default, decimal sequence = default)
        {
            BuyMore = buyMore;
        ...
        public List<ReferenceDealsPost200ResponseDealsInnerDealDiscountsInnerDealDiscountBrandsInner> DealDiscountBrands { get; set; }

        /// <summary>
        /// Gets or Sets DealDiscountCategories
        /// </summary>
        [DataMember(Name = "DealDiscountCategories", IsRequired = true, EmitDefaultValue = true)]
        public List<ReferenceDealsPost200ResponseDealsInnerDealDiscountsInnerDealDiscountCategoriesInner> DealDiscountCategories { get; set; }

        /// <summary>
        /// Gets or Sets DealDiscountProducts
        /// </summary>
        [DataMember(Name = "DealDiscountProducts", IsRequired = true, EmitDefaultValue = true)]
        public List<ReferenceDealsPost200ResponseDealsInnerDealDiscountsInnerDealDiscountProductsInner> DealDiscountProducts { get; set; }

        /// <summary>
        /// Gets or Sets DealDiscountTags
        /// </summary>
        [DataMember(Name = "DealDiscountTags", IsRequired = true, EmitDefaultValue = true)]
        public List<ReferenceDealsPost200ResponseDealsInnerDealDiscountsInnerDealDiscountTagsInner> DealDiscountTags { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReferenceDealsPost200ResponseDealsInnerDealDiscountsInner {\n");
