...
{
    /// <summary>
    /// ProductionOrderProductionorderidReturnattachmentscontentGet200ResponseProductionOrdersInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionOrderProductionorderidReturnattachmentscontentGet200ResponseProductionOrdersInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productionOrder_Productionorderid__Returnattachmentscontent__get_200_response_ProductionOrders_inner")]
    public partial class ProductionOrderProductionorderidReturnattachmentscontentGet200ResponseProductionOrdersInner(string bOMName = default, decimal bOMQuantity = default, decimal bOMVersion = default, string capacityCalculationType = default, string comments = default, object completionDate = default, string costingMethod = default, string customField1 = default, string customField10 = default, string customField2 = default, string customField3 = default, string customField4 = default, string customField5 = default, string customField6 = default, string customField7 = default, string customField8 = default, string customField9 = default, List<string> deliveries = default, string finishedGoodsAccountCode = default, bool isIgnoreLeadTime = default, decimal issueMethodComponent = default, decimal issueMethodParameter = default, string locationID = default, string locationName = default, List<ProductionOrderProductionorderidReturnattachmentscontentGet200ResponseProductionOrdersInnerOperationsInner> operations = default, decimal orderCycleTime = default, string orderNumber = default, string orderStatus = default, string plannedBy = default, string productID = default, string productName = default, string productSKU = default, string productionOrderID = default, decimal quantity = default, string releaseDate = default, string releasedBy = default, string requiredByDate = default, object retailID = default, decimal runSize = default, decimal sourceName = default, object sourceTaskID = default, string sourceTaskNumber = default, List<Authorize200ResponseProductionOrdersInnerSourceTasksInner> sourceTasks = default, string startDate = default, bool startUpdate = default, string status = default, string tags = default, string unit = default, string wIPAccountCode = default, string warehouseID = default, string warehouseName = default) : IValidatableObject
    {
        /// <summary>
        /// Gets or Sets BOMName
        /// </summary>
        [DataMember(Name = "BOMName", EmitDefaultValue = false)]
        public string BOMName { get; set; } = bOMName;
        ...
        public List<ProductionOrderProductionorderidReturnattachmentscontentGet200ResponseProductionOrdersInnerOperationsInner> Operations { get; set; } = operations;

        /// <summary>
        /// Gets or Sets OrderCycleTime
        /// </summary>
        [DataMember(Name = "OrderCycleTime", EmitDefaultValue = false)]
        public decimal OrderCycleTime { get; set; } = orderCycleTime;
        ...
        /// </summary>
        [DataMember(Name = "PlannedBy", EmitDefaultValue = false)]
        public string PlannedBy { get; set; } = plannedBy;
        ...
        /// </summary>
        [DataMember(Name = "ReleasedBy", EmitDefaultValue = false)]
        public string ReleasedBy { get; set; } = releasedBy;
        ...
        /// </summary>
        [DataMember(Name = "SourceTaskNumber", EmitDefaultValue = false)]
        public string SourceTaskNumber { get; set; } = sourceTaskNumber;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionOrderProductionorderidReturnattachmentscontentGet200ResponseProductionOrdersInner {\n");
