...
{
    /// <summary>
    /// ResumeRunOperation200ResponseRunsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ResumeRunOperation200ResponseRunsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "Resume_Run_Operation_200_response_Runs_inner")]
    public partial class ResumeRunOperation200ResponseRunsInner(object dueDate = default, object endDate = default, decimal issueMethodParameter = default, List<string> manualJournals = default, decimal number = default, List<ResumeRunOperation200ResponseRunsInnerOperationsInner> operations = default, List<string> output = default, List<string> pendingOutput = default, decimal quantity = default, string receivedDate = default, string runID = default, string startDate = default, string status = default, string wIPAccount = default) : IValidatableObject
    {
        ...
        public List<ResumeRunOperation200ResponseRunsInnerOperationsInner> Operations { get; set; } = operations;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResumeRunOperation200ResponseRunsInner {\n");
