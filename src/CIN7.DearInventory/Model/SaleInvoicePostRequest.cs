...
{
    /// <summary>
    /// SaleInvoicePostRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="SaleInvoicePostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "saleInvoice_post_request")]
    public partial class SaleInvoicePostRequest(List<SalePut200ResponseCreditNotesInnerAdditionalChargesInner> additionalCharges = default, string billingAddressLine1 = default, string billingAddressLine2 = default, bool combineAdditionalCharges = default, decimal currencyConversionRate = default, string invoiceDate = default, string invoiceDueDate = default, List<SaleInvoicePostRequestLinesInner> lines = default, string linkedFulfillmentNumber = default, string memo = default, string saleID = default, string status = default, string taskID = default) : IValidatableObject
    {
        ...
        public List<SaleInvoicePostRequestLinesInner> Lines { get; set; } = lines;
        ...
        public string SaleID { get; set; } = saleID;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SaleInvoicePostRequest {\n");
