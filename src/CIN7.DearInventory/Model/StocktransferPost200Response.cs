...
{
    /// <summary>
    /// StocktransferPost200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="StocktransferPost200Response" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "stocktransfer_post_200_response")]
    public partial class StocktransferPost200Response(string completionDate = default, string costDistributionType = default, string departureDate = default, string from = default, string fromLocation = default, string inTransitAccount = default, List<StocktransferPut200ResponseLinesInner> lines = default, List<string> manualJournals = default, string number = default, PurchasePut200ResponseCreditNoteUnstock order = default, string reference = default, string requiredByDate = default, bool skipOrder = default, string status = default, string taskID = default, string to = default, string toLocation = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StocktransferPost200Response {\n");
