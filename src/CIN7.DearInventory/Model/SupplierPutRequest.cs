...
namespace CIN7.DearInventory.Model
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="SupplierPutRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "supplier_put_request")]
    public partial class SupplierPutRequest(string accountPayable = default, string additionalAttribute1 = default, object additionalAttribute10 = default, string additionalAttribute2 = default, string additionalAttribute3 = default, object additionalAttribute4 = default, object additionalAttribute5 = default, object additionalAttribute6 = default, object additionalAttribute7 = default, object additionalAttribute8 = default, object additionalAttribute9 = default, List<CrmLeadPutRequestAddressesInner> addresses = default, string attributeSet = default, string comments = default, List<SupplierPutRequestContactsInner> contacts = default, string currency = default, decimal discount = default, string iD = default, string name = default, string paymentTerm = default, string status = default, string taxNumber = default, string taxRule = default) : IValidatableObject
    {
        ...
        public List<CrmLeadPutRequestAddressesInner> Addresses { get; set; } = addresses;
        ...
        public List<SupplierPutRequestContactsInner> Contacts { get; set; } = contacts;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SupplierPutRequest {\n");
