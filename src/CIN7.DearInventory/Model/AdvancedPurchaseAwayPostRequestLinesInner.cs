...
{
    /// <summary>
    /// AdvancedPurchaseAwayPostRequestLinesInner
    /// </summary>
    [DataContract(Name = "advancedPurchaseAway_post_request_Lines_inner")]
    public partial class AdvancedPurchaseAwayPostRequestLinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedPurchaseAwayPostRequestLinesInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected AdvancedPurchaseAwayPostRequestLinesInner()
        { }
        ...
        public AdvancedPurchaseAwayPostRequestLinesInner(string batchSN = default, string date = default, string expiryDate = default, string location = default, string locationID = default, string name = default, string productID = default, decimal quantity = default, bool received = default, string sKU = default, string supplierSKU = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchaseAwayPostRequestLinesInner {\n");
