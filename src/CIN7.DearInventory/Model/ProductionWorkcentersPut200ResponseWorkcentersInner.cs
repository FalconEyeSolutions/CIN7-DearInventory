...
{
    /// <summary>
    /// ProductionWorkcentersPut200ResponseWorkcentersInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionWorkcentersPut200ResponseWorkcentersInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productionWorkcenters_put_200_response_Workcenters_inner")]
    public partial class ProductionWorkcentersPut200ResponseWorkcentersInner(object coManProcurementType = default, string code = default, bool isActive = default, bool isCoMan = default, bool isCoManPurchase = default, string name = default, string supplierID = default, string supplierName = default, string workCenterID = default, List<string> workCenterLocations = default) : IValidatableObject
    {

        /// <summary>
        /// Gets or Sets CoManProcurementType
        /// </summary>
        [DataMember(Name = "CoManProcurementType", EmitDefaultValue = true)]
        public object CoManProcurementType { get; set; } = coManProcurementType;
        ...
        public List<string> WorkCenterLocations { get; set; } = workCenterLocations;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionWorkcentersPut200ResponseWorkcentersInner {\n");
