...
{
    /// <summary>
    /// CompleteRun200ResponseRunsInnerOperationsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="CompleteRun200ResponseRunsInnerOperationsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "Complete_Run_200_response_Runs_inner_Operations_inner")]
    public partial class CompleteRun200ResponseRunsInnerOperationsInner(decimal actualTime = default, List<string> attachments = default, object coManStatus = default, List<string> coManTaskLines = default, List<string> coManTasks = default, List<CompleteRun200ResponseRunsInnerOperationsInnerComponentsInner> components = default, object dueDate = default, string endDate = default, List<string> finishedProducts = default, List<string> inputProducts = default, bool isBackflush = default, bool isDropShip = default, object manualEndDate = default, object manualStartDate = default, string name = default, List<string> notes = default, string operationID = default, string operationType = default, decimal order = default, List<string> outputProducts = default, decimal plannedTime = default, List<string> resourceCosts = default, List<string> resources = default, string startDate = default, string status = default, object suspendReason = default, decimal unitsPerCycle = default, string workCenterCode = default, string workCenterID = default, string workCenterName = default) : IValidatableObject
    {
        /// <summary>
        ...
        public List<CompleteRun200ResponseRunsInnerOperationsInnerComponentsInner> Components { get; set; } = components;
        ...
        /// </summary>
        [DataMember(Name = "ManualEndDate", EmitDefaultValue = true)]
        public object ManualEndDate { get; set; } = manualEndDate;

        /// <summary>
        /// Gets or Sets ManualStartDate
        /// </summary>
        [DataMember(Name = "ManualStartDate", EmitDefaultValue = true)]
        public object ManualStartDate { get; set; } = manualStartDate;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompleteRun200ResponseRunsInnerOperationsInner {\n");
