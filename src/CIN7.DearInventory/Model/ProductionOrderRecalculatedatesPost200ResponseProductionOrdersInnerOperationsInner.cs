...
{
    /// <summary>
    /// ProductionOrderRecalculatedatesPost200ResponseProductionOrdersInnerOperationsInner
    /// </summary>
    [DataContract(Name = "productionOrder_Recalculatedates__post_200_response_ProductionOrders_inner_Operations_inner")]
    public partial class ProductionOrderRecalculatedatesPost200ResponseProductionOrdersInnerOperationsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductionOrderRecalculatedatesPost200ResponseProductionOrdersInnerOperationsInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected ProductionOrderRecalculatedatesPost200ResponseProductionOrdersInnerOperationsInner()
        { }
        ...
        /// <param name="componentLocationID">componentLocationID (required).</param>
        ...
        /// <param name="totalCycleTime">totalCycleTime (required).</param>
        /// <param name="totalUnitsPerCycle">totalUnitsPerCycle (required).</param>
        ...
        /// <param name="workCenterCode">workCenterCode (required).</param>
        /// <param name="workCenterID">workCenterID (required).</param>
        /// <param name="workCenterName">workCenterName (required).</param>
        public ProductionOrderRecalculatedatesPost200ResponseProductionOrdersInnerOperationsInner(List<string> attachments = default, object componentLocationID = default, List<ProductionOrderRecalculatedatesPost200ResponseProductionOrdersInnerOperationsInnerComponentsInner> components = default, decimal cycleTime = default, List<Authorize200ResponseProductionOrdersInnerOperationsInnerOutputProductsInner> finishedProducts = default, List<Authorize200ResponseProductionOrdersInnerOperationsInnerOutputProductsInner> inputProducts = default, bool isBackflush = default, bool isDropShip = default, string name = default, List<Authorize200ResponseProductionOrdersInnerOperationsInnerNotesInner> notes = default, string operationID = default, List<ProductionOrderRecalculatedatesPost200ResponseProductionOrdersInnerOperationsInnerOperationLinksInner> operationLinks = default, string operationType = default, decimal order = default, List<Authorize200ResponseProductionOrdersInnerOperationsInnerOutputProductsInner> outputProducts = default, List<Authorize200ResponseProductionOrdersInnerOperationsInnerResourcesInner> resources = default, decimal totalCycleTime = default, decimal totalUnitsPerCycle = default, decimal unitsPerCycle = default, object workCenterCoManProcurementType = default, string workCenterCode = default, string workCenterID = default, string workCenterName = default)
        {
            // to ensure "attachments" is required (not null)
            ArgumentNullException.ThrowIfNull(attachments);
            Attachments = attachments;
            // to ensure "componentLocationID" is required (not null)
            ArgumentNullException.ThrowIfNull(componentLocationID);
            ...
            TotalUnitsPerCycle = totalUnitsPerCycle;
            ...
            // to ensure "workCenterCode" is required (not null)
            ArgumentNullException.ThrowIfNull(workCenterCode);
        ...
        /// <summary>
        /// Gets or Sets ComponentLocationID
        /// </summary>
        [DataMember(Name = "ComponentLocationID", IsRequired = true, EmitDefaultValue = true)]
        public object ComponentLocationID { get; set; }

        /// <summary>
        /// Gets or Sets Components
        /// </summary>
        [DataMember(Name = "Components", IsRequired = true, EmitDefaultValue = true)]
        public List<ProductionOrderRecalculatedatesPost200ResponseProductionOrdersInnerOperationsInnerComponentsInner> Components { get; set; }
        ...
        public List<Authorize200ResponseProductionOrdersInnerOperationsInnerOutputProductsInner> FinishedProducts { get; set; }

        /// <summary>
        /// Gets or Sets InputProducts
        /// </summary>
        [DataMember(Name = "InputProducts", IsRequired = true, EmitDefaultValue = true)]
        public List<Authorize200ResponseProductionOrdersInnerOperationsInnerOutputProductsInner> InputProducts { get; set; }
        ...
        public List<ProductionOrderRecalculatedatesPost200ResponseProductionOrdersInnerOperationsInnerOperationLinksInner> OperationLinks { get; set; }
        ...
        public List<Authorize200ResponseProductionOrdersInnerOperationsInnerOutputProductsInner> OutputProducts { get; set; }

        /// <summary>
        /// Gets or Sets Resources
        /// </summary>
        [DataMember(Name = "Resources", IsRequired = true, EmitDefaultValue = true)]
        public List<Authorize200ResponseProductionOrdersInnerOperationsInnerResourcesInner> Resources { get; set; }

        /// <summary>
        /// Gets or Sets TotalCycleTime
        /// </summary>
        [DataMember(Name = "TotalCycleTime", IsRequired = true, EmitDefaultValue = true)]
        public decimal TotalCycleTime { get; set; }

        /// <summary>
        /// Gets or Sets TotalUnitsPerCycle
        /// </summary>
        [DataMember(Name = "TotalUnitsPerCycle", IsRequired = true, EmitDefaultValue = true)]
        public decimal TotalUnitsPerCycle { get; set; }
        ...
        /// </summary>
        [DataMember(Name = "WorkCenterCode", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionOrderRecalculatedatesPost200ResponseProductionOrdersInnerOperationsInner {\n");
            sb.Append("  Attachments: ").Append(Attachments).Append('\n');
            sb.Append("  ComponentLocationID: ").Append(ComponentLocationID).Append('\n');
            ...
            sb.Append("  TotalCycleTime: ").Append(TotalCycleTime).Append('\n');
            sb.Append("  TotalUnitsPerCycle: ").Append(TotalUnitsPerCycle).Append('\n');
