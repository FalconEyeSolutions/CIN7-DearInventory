...
namespace CIN7.DearInventory.Model
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="JournalPostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "journal_post_request")]
    public partial class JournalPostRequest(string currency = default, decimal currencyConversionRate = default, string effectiveDate = default, List<JournalPutRequestLinesInner> lines = default, string narration = default, string notes = default, string status = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JournalPostRequest {\n");
