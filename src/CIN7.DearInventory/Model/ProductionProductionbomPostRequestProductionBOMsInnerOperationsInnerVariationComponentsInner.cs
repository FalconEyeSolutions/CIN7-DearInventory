...
{
    /// <summary>
    /// ProductionProductionbomPostRequestProductionBOMsInnerOperationsInnerVariationComponentsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionProductionbomPostRequestProductionBOMsInnerOperationsInnerVariationComponentsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productionProductionbom_post_request_ProductionBOMs_inner_Operations_inner_VariationComponents_inner")]
    public partial class ProductionProductionbomPostRequestProductionBOMsInnerOperationsInnerVariationComponentsInner(decimal cost = default, string costingMethod = default, string mapVariationsJSON = default, decimal position = default, string productFamilySKU = default, string quantityOptionName = default, string quantitySettingsJSON = default, object salePriceTier = default, string unit = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionProductionbomPostRequestProductionBOMsInnerOperationsInnerVariationComponentsInner {\n");
