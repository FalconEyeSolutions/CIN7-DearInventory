...
{
    /// <summary>
    /// MoneyoperationPutRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="MoneyoperationPutRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "moneyoperation_put_request")]
    public partial class MoneyoperationPutRequest(string bankAccount = default, decimal currencyConversionRate = default, object customerID = default, string date = default, List<MoneyoperationPutRequestLinesInner> lines = default, object note = default, string reference = default, string status = default, object supplierID = default, string taskID = default, string taskType = default, bool taxInclusive = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MoneyoperationPutRequest {\n");
