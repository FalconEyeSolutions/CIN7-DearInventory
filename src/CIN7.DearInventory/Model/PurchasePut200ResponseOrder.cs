...
{
    /// <summary>
    /// PurchasePut200ResponseOrder
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="PurchasePut200ResponseOrder" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "purchase_put_200_response_Order")]
    public partial class PurchasePut200ResponseOrder(List<string> additionalCharges = default, List<string> lines = default, object memo = default, List<string> prepayments = default, string status = default, decimal tax = default, decimal total = default, decimal totalBeforeTax = default) : IValidatableObject
    {
        ...
        public object Memo { get; set; } = memo;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchasePut200ResponseOrder {\n");
