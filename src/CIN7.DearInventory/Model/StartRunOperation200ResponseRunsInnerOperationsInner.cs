...
{
    /// <summary>
    /// StartRunOperation200ResponseRunsInnerOperationsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="StartRunOperation200ResponseRunsInnerOperationsInner" /> class.
    /// </remarks>
    ...
    public partial class StartRunOperation200ResponseRunsInnerOperationsInner(object actualTime = default, List<CompleteRunOperation200ResponseRunsInnerOperationsInnerAttachmentsInner> attachments = default, object coManStatus = default, List<string> coManTaskLines = default, List<string> coManTasks = default, List<ResumeRunOperation200ResponseRunsInnerOperationsInnerComponentsInner> components = default, object dueDate = default, object endDate = default, List<string> finishedProducts = default, List<string> inputProducts = default, bool isBackflush = default, bool isDropShip = default, object manualEndDate = default, string manualStartDate = default, string name = default, List<string> notes = default, string operationID = default, string operationType = default, decimal order = default, List<string> outputProducts = default, decimal plannedTime = default, List<CompleteRunOperation200ResponseRunsInnerOperationsInnerResourceCostsInner> resourceCosts = default, List<CompleteRunOperation200ResponseRunsInnerOperationsInnerResourcesInner> resources = default, string startDate = default, string status = default, object suspendReason = default, decimal unitsPerCycle = default, string workCenterCode = default, string workCenterID = default, string workCenterName = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StartRunOperation200ResponseRunsInnerOperationsInner {\n");
