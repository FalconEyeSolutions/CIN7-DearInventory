...
{
    /// <summary>
    /// SaleFulfilmentShipPutRequestLinesInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="SaleFulfilmentShipPutRequestLinesInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "saleFulfilmentShip_put_request_Lines_inner")]
    public partial class SaleFulfilmentShipPutRequestLinesInner(string box = default, string carrier = default, bool isShipped = default, string shipmentDate = default, string trackingNumber = default, string trackingURL = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SaleFulfilmentShipPutRequestLinesInner {\n");
