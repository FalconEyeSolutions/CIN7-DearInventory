...
{
    /// <summary>
    /// ProductAttachmentsPost200ResponseInner
    /// </summary>
    [DataContract(Name = "productAttachments_post_200_response_inner")]
    public partial class ProductAttachmentsPost200ResponseInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductAttachmentsPost200ResponseInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected ProductAttachmentsPost200ResponseInner()
        { }
        ...
        public ProductAttachmentsPost200ResponseInner(string contentType = default, string downloadUrl = default, string fileName = default, string iD = default, string isDefault = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductAttachmentsPost200ResponseInner {\n");
