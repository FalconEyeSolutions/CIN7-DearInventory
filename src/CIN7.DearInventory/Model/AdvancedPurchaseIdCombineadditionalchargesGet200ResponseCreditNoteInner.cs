...
{
    /// <summary>
    /// AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInner
    /// </summary>
    [DataContract(Name = "advancedPurchase_Id__Combineadditionalcharges__get_200_response_CreditNote_inner")]
    public partial class AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInner()
        { }
        ...
        public AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInner(List<string> additionalCharges = default, string creditNoteDate = default, string creditNoteInvoiceNumber = default, string creditNoteNumber = default, List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInnerLinesInner> lines = default, List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInnerRefundsInner> refunds = default, string status = default, string taskID = default, decimal tax = default, decimal total = default, decimal totalBeforeTax = default, List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInnerUnstockInner> unstock = default)
        {
        ...
        public List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInnerLinesInner> Lines { get; set; }

        /// <summary>
        /// Gets or Sets Refunds
        /// </summary>
        [DataMember(Name = "Refunds", IsRequired = true, EmitDefaultValue = true)]
        public List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInnerRefundsInner> Refunds { get; set; }
        ...
        public List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInnerUnstockInner> Unstock { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInner {\n");
