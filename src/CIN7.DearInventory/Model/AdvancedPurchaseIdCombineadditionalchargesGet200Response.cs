...
{
    /// <summary>
    /// AdvancedPurchaseIdCombineadditionalchargesGet200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="AdvancedPurchaseIdCombineadditionalchargesGet200Response" /> class.
    /// </remarks>
    ...
    /// <param name="combinedReceivingStatus">combinedReceivingStatus.</param>
    ...
    /// <param name="isServiceOnly">isServiceOnly.</param>
    ...
    /// <param name="putAway">putAway.</param>
    ...
    [DataContract(Name = "advancedPurchase_Id__Combineadditionalcharges__get_200_response")]
    public partial class AdvancedPurchaseIdCombineadditionalchargesGet200Response(AdvancedPurchasePutRequestAdditionalAttributes additionalAttributes = default, string approach = default, List<string> attachments = default, string baseCurrency = default, AdvancedPurchaseIdCombineadditionalchargesGet200ResponseBillingAddress billingAddress = default, bool blindReceipt = default, string combinedInvoiceStatus = default, string combinedPaymentStatus = default, string combinedReceivingStatus = default, string contact = default, List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInner> creditNote = default, decimal currencyRate = default, string iD = default, string inventoryAccount = default, List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInventoryMovementsInner> inventoryMovements = default, List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInvoiceInner> invoice = default, bool isServiceOnly = default, string lastUpdatedDate = default, string location = default, List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseManualJournalsInner> manualJournals = default, string note = default, AdvancedPurchaseIdCombineadditionalchargesGet200ResponseOrder order = default, string orderDate = default, string orderNumber = default, string phone = default, List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponsePutAwayInner> putAway = default, object relatedDropShipSaleTask = default, object requiredBy = default, AdvancedPurchasePut200ResponseShippingAddress shippingAddress = default, string status = default, List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseStockReceivedInner> stockReceived = default, string supplier = default, string supplierCurrency = default, string supplierID = default, string taxCalculation = default, string taxRule = default, string terms = default, string type = default) : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name = "CombinedReceivingStatus", EmitDefaultValue = false)]
        public string CombinedReceivingStatus { get; set; } = combinedReceivingStatus;
        ...
        public List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseCreditNoteInner> CreditNote { get; set; } = creditNote;
        ...
        public List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInventoryMovementsInner> InventoryMovements { get; set; } = inventoryMovements;

        /// <summary>
        /// Gets or Sets Invoice
        /// </summary>
        [DataMember(Name = "Invoice", EmitDefaultValue = false)]
        public List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInvoiceInner> Invoice { get; set; } = invoice;

        /// <summary>
        /// Gets or Sets IsServiceOnly
        /// </summary>
        [DataMember(Name = "IsServiceOnly", EmitDefaultValue = true)]
        public bool IsServiceOnly { get; set; } = isServiceOnly;
        ...
        public List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseManualJournalsInner> ManualJournals { get; set; } = manualJournals;
        ...
        public AdvancedPurchaseIdCombineadditionalchargesGet200ResponseOrder Order { get; set; } = order;
        ...
        /// <summary>
        /// Gets or Sets PutAway
        /// </summary>
        [DataMember(Name = "PutAway", EmitDefaultValue = false)]
        public List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponsePutAwayInner> PutAway { get; set; } = putAway;
        ...
        public List<AdvancedPurchaseIdCombineadditionalchargesGet200ResponseStockReceivedInner> StockReceived { get; set; } = stockReceived;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchaseIdCombineadditionalchargesGet200Response {\n");
            ...
            sb.Append("  PutAway: ").Append(PutAway).Append('\n');
