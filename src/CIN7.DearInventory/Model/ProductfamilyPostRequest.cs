...
namespace CIN7.DearInventory.Model
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductfamilyPostRequest" /> class.
    /// </remarks>
    ...
    public partial class ProductfamilyPostRequest(object attributeSet = default, object brand = default, object cOGSAccount = default, string category = default, string costingMethod = default, string countryOfOrigin = default, string defaultLocation = default, string description = default, object discountRule = default, string dropShipMode = default, string hSCode = default, object inventoryAccount = default, decimal minimumBeforeReorder = default, string name = default, string option1Name = default, string option2Name = default, string option3Name = default, decimal priceTier1 = default, decimal priceTier10 = default, decimal priceTier2 = default, decimal priceTier3 = default, decimal priceTier4 = default, decimal priceTier5 = default, decimal priceTier6 = default, decimal priceTier7 = default, decimal priceTier8 = default, decimal priceTier9 = default, List<ProductfamilyPostRequestProductsInner> products = default, object purchaseTaxRule = default, decimal reorderQuantity = default, object revenueAccount = default, string sKU = default, object saleTaxRule = default, string shortDescription = default, string tags = default, string uOM = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductfamilyPostRequest {\n");
