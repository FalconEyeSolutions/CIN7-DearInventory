...
{
    /// <summary>
    /// DisassemblyIdVoidDelete200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="DisassemblyIdVoidDelete200Response" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "disassembly_Id__Void__delete_200_response")]
    public partial class DisassemblyIdVoidDelete200Response(string assemblyInstructionURL = default, string completionDate = default, string disassemblyNumber = default, List<string> errors = default, string location = default, string locationID = default, List<string> orderLines = default, List<string> orderServiceLines = default, List<string> pickLines = default, string productCode = default, string productID = default, string productName = default, decimal quantity = default, string status = default, string taskID = default, List<string> transactions = default, string wIPAccount = default) : IValidatableObject
    {
        /// <summary>
        ...
        public List<string> OrderServiceLines { get; set; } = orderServiceLines;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DisassemblyIdVoidDelete200Response {\n");
