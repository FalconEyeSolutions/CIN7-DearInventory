...
{
    /// <summary>
    /// ProductionOrderRecalculatedatesPostRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionOrderRecalculatedatesPostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productionOrder_Recalculatedates__post_request")]
    public partial class ProductionOrderRecalculatedatesPostRequest(decimal bOMVersion = default, string capacityCalculationType = default, string finishedGoodsAccountCode = default, bool isIgnoreLeadTime = default, string locationID = default, string locationName = default, string productID = default, string productSKU = default, decimal quantity = default, string startDate = default, string wIPAccountCode = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionOrderRecalculatedatesPostRequest {\n");
