...
{
    /// <summary>
    /// ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInnerFinishedProductsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInnerFinishedProductsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productionProductionbom_post_200_response_ProductionBOMs_inner_Operations_inner_FinishedProducts_inner")]
    public partial class ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInnerFinishedProductsInner(decimal averageCost = default, string costCalculationType = default, string costingMethod = default, object deliveryTo = default, object deliveryToName = default, string iD = default, decimal outputQuantity = default, decimal position = default, decimal priceTier = default, string productFamilyID = default, object productID = default, string productName = default, string productSKU = default, decimal ratio = default, string unit = default, object wastageCost = default) : IValidatableObject
    {
        ...
        public object ProductID { get; set; } = productID;
        ...
        /// </summary>
        [DataMember(Name = "WastageCost", EmitDefaultValue = true)]
        public object WastageCost { get; set; } = wastageCost;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInnerFinishedProductsInner {\n");
