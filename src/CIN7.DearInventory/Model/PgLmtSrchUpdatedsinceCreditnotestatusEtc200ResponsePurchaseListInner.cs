...
{
    /// <summary>
    /// PgLmtSrchUpdatedsinceCreditnotestatusEtc200ResponsePurchaseListInner
    /// </summary>
    [DataContract(Name = "Pg__Lmt__Srch__Updatedsince__Creditnotestatus__Etc_200_response_PurchaseList_inner")]
    public partial class PgLmtSrchUpdatedsinceCreditnotestatusEtc200ResponsePurchaseListInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PgLmtSrchUpdatedsinceCreditnotestatusEtc200ResponsePurchaseListInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected PgLmtSrchUpdatedsinceCreditnotestatusEtc200ResponsePurchaseListInner()
        { }
        ...
        /// <param name="blindReceipt">blindReceipt (required).</param>
        ...
        /// <param name="combinedReceivingStatus">combinedReceivingStatus (required).</param>
        /// <param name="creditNoteNumber">creditNoteNumber (required).</param>
        /// <param name="creditNoteStatus">creditNoteStatus (required).</param>
        /// <param name="dropShipTaskID">dropShipTaskID (required).</param>
        ...
        /// <param name="isServiceOnly">isServiceOnly (required).</param>
        ...
        /// <param name="requiredBy">requiredBy (required).</param>
        /// <param name="status">status (required).</param>
        /// <param name="stockReceivedStatus">stockReceivedStatus (required).</param>
        /// <param name="supplier">supplier (required).</param>
        /// <param name="supplierCurrency">supplierCurrency (required).</param>
        /// <param name="supplierID">supplierID (required).</param>
        /// <param name="type">type (required).</param>
        /// <param name="unstockStatus">unstockStatus (required).</param>
        public PgLmtSrchUpdatedsinceCreditnotestatusEtc200ResponsePurchaseListInner(string baseCurrency = default, bool blindReceipt = default, string combinedInvoiceStatus = default, string combinedPaymentStatus = default, string combinedReceivingStatus = default, string creditNoteNumber = default, string creditNoteStatus = default, object dropShipTaskID = default, string iD = default, decimal invoiceAmount = default, string invoiceDate = default, string invoiceDueDate = default, string invoiceNumber = default, string invoiceStatus = default, bool isServiceOnly = default, string lastUpdatedDate = default, string orderDate = default, string orderNumber = default, string orderStatus = default, decimal paidAmount = default, object requiredBy = default, string status = default, string stockReceivedStatus = default, string supplier = default, string supplierCurrency = default, string supplierID = default, string type = default, string unstockStatus = default)
        {
            ...
            // to ensure "combinedReceivingStatus" is required (not null)
            ArgumentNullException.ThrowIfNull(combinedReceivingStatus);
            CombinedReceivingStatus = combinedReceivingStatus;
            ...
            // to ensure "dropShipTaskID" is required (not null)
            ArgumentNullException.ThrowIfNull(dropShipTaskID);
            DropShipTaskID = dropShipTaskID;
            ...
            ArgumentNullException.ThrowIfNull(invoiceStatus);
            InvoiceStatus = invoiceStatus;
            IsServiceOnly = isServiceOnly;
            // to ensure "lastUpdatedDate" is required (not null)
            ArgumentNullException.ThrowIfNull(lastUpdatedDate);
            ...
            // to ensure "requiredBy" is required (not null)
            ArgumentNullException.ThrowIfNull(requiredBy);
            RequiredBy = requiredBy;
            // to ensure "status" is required (not null)
            ArgumentNullException.ThrowIfNull(status);
            Status = status;
            // to ensure "stockReceivedStatus" is required (not null)
            ArgumentNullException.ThrowIfNull(stockReceivedStatus);
            StockReceivedStatus = stockReceivedStatus;
            // to ensure "supplier" is required (not null)
            ArgumentNullException.ThrowIfNull(supplier);
            Supplier = supplier;
            // to ensure "supplierCurrency" is required (not null)
            ArgumentNullException.ThrowIfNull(supplierCurrency);
            ...
            Type = type;
            // to ensure "unstockStatus" is required (not null)
            ArgumentNullException.ThrowIfNull(unstockStatus);
            UnstockStatus = unstockStatus;
        }
        ...
        /// </summary>
        [DataMember(Name = "BlindReceipt", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <summary>
        /// Gets or Sets CombinedReceivingStatus
        /// </summary>
        [DataMember(Name = "CombinedReceivingStatus", IsRequired = true, EmitDefaultValue = true)]
        public string CombinedReceivingStatus { get; set; }
        ...
        /// <summary>
        /// Gets or Sets DropShipTaskID
        /// </summary>
        [DataMember(Name = "DropShipTaskID", IsRequired = true, EmitDefaultValue = true)]
        public object DropShipTaskID { get; set; }
        ...
        /// <summary>
        /// Gets or Sets IsServiceOnly
        /// </summary>
        [DataMember(Name = "IsServiceOnly", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "RequiredBy", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <summary>
        /// Gets or Sets StockReceivedStatus
        /// </summary>
        [DataMember(Name = "StockReceivedStatus", IsRequired = true, EmitDefaultValue = true)]
        public string StockReceivedStatus { get; set; }
        ...
        /// </summary>
        [DataMember(Name = "SupplierCurrency", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <summary>
        /// Gets or Sets UnstockStatus
        /// </summary>
        [DataMember(Name = "UnstockStatus", IsRequired = true, EmitDefaultValue = true)]
        public string UnstockStatus { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PgLmtSrchUpdatedsinceCreditnotestatusEtc200ResponsePurchaseListInner {\n");
            ...
            sb.Append("  CombinedReceivingStatus: ").Append(CombinedReceivingStatus).Append('\n');
            sb.Append("  CreditNoteNumber: ").Append(CreditNoteNumber).Append('\n');
            sb.Append("  CreditNoteStatus: ").Append(CreditNoteStatus).Append('\n');
            sb.Append("  DropShipTaskID: ").Append(DropShipTaskID).Append('\n');
            ...
            sb.Append("  IsServiceOnly: ").Append(IsServiceOnly).Append('\n');
            ...
            sb.Append("  StockReceivedStatus: ").Append(StockReceivedStatus).Append('\n');
            sb.Append("  Supplier: ").Append(Supplier).Append('\n');
            sb.Append("  SupplierCurrency: ").Append(SupplierCurrency).Append('\n');
            sb.Append("  SupplierID: ").Append(SupplierID).Append('\n');
            sb.Append("  Type: ").Append(Type).Append('\n');
            sb.Append("  UnstockStatus: ").Append(UnstockStatus).Append('\n');
            sb.Append("}\n");
            return sb.ToString();
        }
