...
{
    /// <summary>
    /// SalePaymentPostRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="SalePaymentPostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "salePayment_post_request")]
    public partial class SalePaymentPostRequest(string account = default, decimal amount = default, object creditID = default, decimal currencyRate = default, string datePaid = default, string reference = default, string taskID = default, string type = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalePaymentPostRequest {\n");
