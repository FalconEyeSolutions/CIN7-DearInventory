...
{
    /// <summary>
    /// ProductPutRequestSuppliersInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductPutRequestSuppliersInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "product_put_request_Suppliers_inner")]
    public partial class ProductPutRequestSuppliersInner(decimal cost = default, string currency = default, bool dropShip = default, decimal fixedCost = default, string supplierID = default, string supplierInventoryCode = default, string supplierName = default, string supplierProductName = default, string uRL = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductPutRequestSuppliersInner {\n");
