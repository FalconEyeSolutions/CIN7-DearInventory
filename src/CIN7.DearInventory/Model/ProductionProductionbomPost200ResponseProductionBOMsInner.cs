...
{
    /// <summary>
    /// ProductionProductionbomPost200ResponseProductionBOMsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionProductionbomPost200ResponseProductionBOMsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productionProductionbom_post_200_response_ProductionBOMs_inner")]
    public partial class ProductionProductionbomPost200ResponseProductionBOMsInner(string bOMID = default, decimal bufferPercent = default, decimal componentProductionLeadTime = default, string createdDate = default, object deliveryToID = default, object deliveryToName = default, bool ignoreCumulativeLeadTime = default, string instructionUrl = default, bool isDefault = default, decimal issueMethod = default, string name = default, List<ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInner> operations = default, decimal outputQuantity = default, decimal varVersion = default) : IValidatableObject
    {
        ...
        public List<ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInner> Operations { get; set; } = operations;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionProductionbomPost200ResponseProductionBOMsInner {\n");
