...
{
    /// <summary>
    /// ProductionProductionbomProductidReturnattachmentscontentGet200ResponseProductionBOMsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionProductionbomProductidReturnattachmentscontentGet200ResponseProductionBOMsInner" /> class.
    /// </remarks>
    ...
    /// <param name="deliveryToID">deliveryToID.</param>
    /// <param name="deliveryToName">deliveryToName.</param>
    /// <param name="deviationPercent">deviationPercent.</param>
    /// <param name="ignoreCumulativeLeadTime">ignoreCumulativeLeadTime.</param>
    /// <param name="instructionUrl">instructionUrl.</param>
    /// <param name="isDefault">isDefault.</param>
    /// <param name="isTracing">isTracing.</param>
    ...
    [DataContract(Name = "productionProductionbom_Productid__Returnattachmentscontent__get_200_response_ProductionBOMs_inner")]
    public partial class ProductionProductionbomProductidReturnattachmentscontentGet200ResponseProductionBOMsInner(string bOMID = default, decimal bufferPercent = default, decimal componentProductionLeadTime = default, string createdDate = default, object deliveryToID = default, object deliveryToName = default, decimal deviationPercent = default, bool ignoreCumulativeLeadTime = default, string instructionUrl = default, bool isDefault = default, bool isTracing = default, decimal issueMethod = default, decimal issueMethodComponent = default, decimal issueMethodParameter = default, decimal maxQuantity = default, decimal minQuantity = default, string name = default, List<ProductionProductionbomProductidReturnattachmentscontentGet200ResponseProductionBOMsInnerOperationsInner> operations = default, decimal outputQuantity = default, decimal runSize = default, decimal varVersion = default) : IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets DeliveryToID
        /// </summary>
        [DataMember(Name = "DeliveryToID", EmitDefaultValue = true)]
        public object DeliveryToID { get; set; } = deliveryToID;

        /// <summary>
        /// Gets or Sets DeliveryToName
        /// </summary>
        [DataMember(Name = "DeliveryToName", EmitDefaultValue = true)]
        public object DeliveryToName { get; set; } = deliveryToName;

        /// <summary>
        /// Gets or Sets DeviationPercent
        /// </summary>
        [DataMember(Name = "DeviationPercent", EmitDefaultValue = false)]
        public decimal DeviationPercent { get; set; } = deviationPercent;
        ...
        /// <summary>
        /// Gets or Sets IsTracing
        /// </summary>
        [DataMember(Name = "IsTracing", EmitDefaultValue = true)]
        public bool IsTracing { get; set; } = isTracing;
        ...
        public List<ProductionProductionbomProductidReturnattachmentscontentGet200ResponseProductionBOMsInnerOperationsInner> Operations { get; set; } = operations;
        ...
        public decimal VarVersion { get; set; } = varVersion;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionProductionbomProductidReturnattachmentscontentGet200ResponseProductionBOMsInner {\n");
            ...
            sb.Append("  DeliveryToID: ").Append(DeliveryToID).Append('\n');
            sb.Append("  DeliveryToName: ").Append(DeliveryToName).Append('\n');
            sb.Append("  DeviationPercent: ").Append(DeviationPercent).Append('\n');
            ...
            sb.Append("  IsTracing: ").Append(IsTracing).Append('\n');
