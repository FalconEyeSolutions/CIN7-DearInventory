...
{
    /// <summary>
    /// AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInvoiceInnerLinesInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInvoiceInnerLinesInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "advancedPurchase_Id__Combineadditionalcharges__get_200_response_Invoice_inner_Lines_inner")]
    public partial class AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInvoiceInnerLinesInner(string account = default, string comment = default, string dimensionsUnits = default, decimal discount = default, string name = default, decimal price = default, string productCustomField1 = default, string productCustomField10 = default, string productCustomField2 = default, string productCustomField3 = default, string productCustomField4 = default, string productCustomField5 = default, string productCustomField6 = default, string productCustomField7 = default, string productCustomField8 = default, string productCustomField9 = default, decimal productHeight = default, string productID = default, decimal productLength = default, decimal productWeight = default, decimal productWidth = default, decimal quantity = default, string sKU = default, decimal tax = default, string taxRule = default, decimal total = default, string weightUnits = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInvoiceInnerLinesInner {\n");
