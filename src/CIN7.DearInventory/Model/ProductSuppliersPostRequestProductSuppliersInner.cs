...
{
    /// <summary>
    /// ProductSuppliersPostRequestProductSuppliersInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductSuppliersPostRequestProductSuppliersInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productSuppliers_post_request_ProductSuppliers_inner")]
    public partial class ProductSuppliersPostRequestProductSuppliersInner(decimal cost = default, string currency = default, bool dropShip = default, decimal fixedCost = default, string productID = default, List<ProductSuppliersPostRequestProductSuppliersInnerProductSupplierOptionsInner> productSupplierOptions = default, decimal purchaseCost = default, string supplierID = default, string supplierInventoryCode = default, string supplierProductName = default, string supplierProductURL = default) : IValidatableObject
    {
        ...
        public List<ProductSuppliersPostRequestProductSuppliersInnerProductSupplierOptionsInner> ProductSupplierOptions { get; set; } = productSupplierOptions;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductSuppliersPostRequestProductSuppliersInner {\n");
