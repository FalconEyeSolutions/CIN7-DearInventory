...
{
    /// <summary>
    /// PurchaseIdCombineadditionalchargesGet200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="PurchaseIdCombineadditionalchargesGet200Response" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "purchase_Id__Combineadditionalcharges__get_200_response")]
    public partial class PurchaseIdCombineadditionalchargesGet200Response(AdvancedPurchasePutRequestAdditionalAttributes additionalAttributes = default, string approach = default, List<JournalPgLmtTaskidStsSrchGet200ResponseJournalsInnerAttachmentsInner> attachments = default, string baseCurrency = default, AdvancedPurchasePut200ResponseBillingAddress billingAddress = default, bool blindReceipt = default, string contact = default, PurchaseIdCombineadditionalchargesGet200ResponseCreditNote creditNote = default, decimal currencyRate = default, string iD = default, string inventoryAccount = default, List<PurchaseIdCombineadditionalchargesGet200ResponseInventoryMovementsInner> inventoryMovements = default, PurchaseIdCombineadditionalchargesGet200ResponseInvoice invoice = default, string lastUpdatedDate = default, string location = default, PurchaseIdCombineadditionalchargesGet200ResponseManualJournals manualJournals = default, string note = default, PurchaseIdCombineadditionalchargesGet200ResponseOrder order = default, string orderDate = default, string orderNumber = default, string phone = default, object relatedDropShipSaleTask = default, object requiredBy = default, PurchaseIdCombineadditionalchargesGet200ResponseShippingAddress shippingAddress = default, string status = default, PurchaseIdCombineadditionalchargesGet200ResponseStockReceived stockReceived = default, string supplier = default, string supplierCurrency = default, string supplierID = default, string taxCalculation = default, string taxRule = default, string terms = default) : IValidatableObject
    {
        ...
        public PurchaseIdCombineadditionalchargesGet200ResponseCreditNote CreditNote { get; set; } = creditNote;
        ...
        public PurchaseIdCombineadditionalchargesGet200ResponseInvoice Invoice { get; set; } = invoice;
        ...
        public PurchaseIdCombineadditionalchargesGet200ResponseManualJournals ManualJournals { get; set; } = manualJournals;
        ...
        public PurchaseIdCombineadditionalchargesGet200ResponseOrder Order { get; set; } = order;
        ...
        public PurchaseIdCombineadditionalchargesGet200ResponseShippingAddress ShippingAddress { get; set; } = shippingAddress;
        ...
        public PurchaseIdCombineadditionalchargesGet200ResponseStockReceived StockReceived { get; set; } = stockReceived;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseIdCombineadditionalchargesGet200Response {\n");
