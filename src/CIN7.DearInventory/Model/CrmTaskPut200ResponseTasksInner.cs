...
{
    /// <summary>
    /// CrmTaskPut200ResponseTasksInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="CrmTaskPut200ResponseTasksInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "crmTask_put_200_response_Tasks_inner")]
    public partial class CrmTaskPut200ResponseTasksInner(string assignedBy = default, string assignedTo = default, string category = default, object completedDate = default, object description = default, string endDate = default, string entityID = default, string entityType = default, string iD = default, bool isAllDay = default, bool isImportant = default, string name = default, string startDate = default, string taskStatus = default, object voidDate = default, object workflowName = default) : IValidatableObject
    {
        /// <summary>
        /// Gets or Sets AssignedBy
        /// </summary>
        [DataMember(Name = "AssignedBy", EmitDefaultValue = false)]
        ...
        public object CompletedDate { get; set; } = completedDate;
        ...
        /// </summary>
        [DataMember(Name = "IsImportant", EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "VoidDate", EmitDefaultValue = true)]
        public object VoidDate { get; set; } = voidDate;

        /// <summary>
        /// Gets or Sets WorkflowName
        /// </summary>
        [DataMember(Name = "WorkflowName", EmitDefaultValue = true)]
        public object WorkflowName { get; set; } = workflowName;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrmTaskPut200ResponseTasksInner {\n");
