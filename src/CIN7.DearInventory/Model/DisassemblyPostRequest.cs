...
{
    /// <summary>
    /// DisassemblyPostRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="DisassemblyPostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "disassembly_post_request")]
    public partial class DisassemblyPostRequest(string completionDate = default, string location = default, string locationID = default, string productCode = default, string productID = default, string productName = default, decimal quantity = default, string status = default, string wIPAccount = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DisassemblyPostRequest {\n");
