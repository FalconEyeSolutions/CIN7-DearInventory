...
{
    /// <summary>
    /// AdvancedPurchaseIdCombineadditionalchargesGet200ResponseStockReceivedInnerLinesInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="AdvancedPurchaseIdCombineadditionalchargesGet200ResponseStockReceivedInnerLinesInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "advancedPurchase_Id__Combineadditionalcharges__get_200_response_StockReceived_inner_Lines_inner")]
    public partial class AdvancedPurchaseIdCombineadditionalchargesGet200ResponseStockReceivedInnerLinesInner(string batchSN = default, string cardID = default, string date = default, string dimensionsUnits = default, object expiryDate = default, object location = default, object locationID = default, string name = default, string productCustomField1 = default, string productCustomField10 = default, string productCustomField2 = default, string productCustomField3 = default, string productCustomField4 = default, string productCustomField5 = default, string productCustomField6 = default, string productCustomField7 = default, string productCustomField8 = default, string productCustomField9 = default, decimal productHeight = default, string productID = default, decimal productLength = default, decimal productWeight = default, decimal productWidth = default, decimal quantity = default, bool received = default, string sKU = default, string supplierSKU = default, string weightUnits = default) : IValidatableObject
    {
        /// <summary>
        ...
        public object Location { get; set; } = location;

        /// <summary>
        /// Gets or Sets LocationID
        /// </summary>
        [DataMember(Name = "LocationID", EmitDefaultValue = true)]
        public object LocationID { get; set; } = locationID;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchaseIdCombineadditionalchargesGet200ResponseStockReceivedInnerLinesInner {\n");
