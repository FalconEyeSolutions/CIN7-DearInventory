...
{
    /// <summary>
    /// CrmOpportunityPutRequestLinesInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="CrmOpportunityPutRequestLinesInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "crmOpportunity_put_request_Lines_inner")]
    public partial class CrmOpportunityPutRequestLinesInner(string comment = default, decimal discount = default, decimal price = default, string productID = default, string productName = default, string productSku = default, decimal quantity = default, decimal tax = default, decimal taxPercent = default, string taxRule = default, decimal total = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrmOpportunityPutRequestLinesInner {\n");
