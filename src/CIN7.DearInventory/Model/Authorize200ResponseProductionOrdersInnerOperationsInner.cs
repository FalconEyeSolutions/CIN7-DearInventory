...
{
    /// <summary>
    /// Authorize200ResponseProductionOrdersInnerOperationsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="Authorize200ResponseProductionOrdersInnerOperationsInner" /> class.
    /// </remarks>
    ...
    public partial class Authorize200ResponseProductionOrdersInnerOperationsInner(List<string> attachments = default, object componentLocationID = default, List<Authorize200ResponseProductionOrdersInnerOperationsInnerComponentsInner> components = default, decimal cycleTime = default, List<string> finishedProducts = default, List<string> inputProducts = default, bool isBackflush = default, bool isDropShip = default, string name = default, List<Authorize200ResponseProductionOrdersInnerOperationsInnerNotesInner> notes = default, string operationID = default, List<Authorize200ResponseProductionOrdersInnerOperationsInnerOperationLinksInner> operationLinks = default, string operationType = default, decimal order = default, List<Authorize200ResponseProductionOrdersInnerOperationsInnerOutputProductsInner> outputProducts = default, List<Authorize200ResponseProductionOrdersInnerOperationsInnerResourcesInner> resources = default, decimal totalCycleTime = default, decimal totalUnitsPerCycle = default, decimal unitsPerCycle = default, object workCenterCoManProcurementType = default, string workCenterCode = default, string workCenterID = default, string workCenterName = default) : IValidatableObject
    {
        ...
        public List<Authorize200ResponseProductionOrdersInnerOperationsInnerNotesInner> Notes { get; set; } = notes;
        ...
        public List<Authorize200ResponseProductionOrdersInnerOperationsInnerOutputProductsInner> OutputProducts { get; set; } = outputProducts;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Authorize200ResponseProductionOrdersInnerOperationsInner {\n");
