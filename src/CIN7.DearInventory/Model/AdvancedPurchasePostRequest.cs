...
{
    /// <summary>
    /// AdvancedPurchasePostRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="AdvancedPurchasePostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "advancedPurchase_post_request")]
    public partial class AdvancedPurchasePostRequest(AdvancedPurchasePutRequestAdditionalAttributes additionalAttributes = default, string approach = default, AdvancedPurchasePutRequestBillingAddress billingAddress = default, bool blindReceipt = default, string contact = default, decimal currencyRate = default, string location = default, string note = default, string phone = default, string purchaseType = default, object requiredBy = default, AdvancedPurchasePutRequestShippingAddress shippingAddress = default, string supplier = default, string supplierID = default, string taxCalculation = default, string taxRule = default, string terms = default) : IValidatableObject
    {
        /// <summary>
        ...
        public string PurchaseType { get; set; } = purchaseType;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchasePostRequest {\n");
