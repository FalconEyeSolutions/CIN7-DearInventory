...
namespace CIN7.DearInventory.Model
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="CrmLeadPutRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "crmLead_put_request")]
    public partial class CrmLeadPutRequest(List<CrmLeadPutRequestAddressesInner> addresses = default, decimal amount = default, decimal closeChance = default, string closeDate = default, string comments = default, List<CrmLeadPutRequestContactsInner> contacts = default, string currency = default, string leadStatus = default, string name = default, string paymentTerm = default, string priceTier = default, string salesRepresentative = default, string taxRule = default) : IValidatableObject
    {
        /// <summary>
        ...
        public List<CrmLeadPutRequestContactsInner> Contacts { get; set; } = contacts;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrmLeadPutRequest {\n");
