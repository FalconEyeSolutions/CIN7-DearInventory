...
{
    /// <summary>
    /// FinishedgoodsPickPost200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="FinishedgoodsPickPost200Response" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "finishedgoodsPick_post_200_response")]
    public partial class FinishedgoodsPickPost200Response(string account = default, string completionDate = default, List<FinishedgoodsPickPostRequestPickLinesInner> pickLines = default, string status = default, string taskID = default, string wIPAccount = default, string wIPDate = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FinishedgoodsPickPost200Response {\n");
