...
{
    /// <summary>
    /// SaleInvoiceTaskidVoidDelete200ResponseInvoicesInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="SaleInvoiceTaskidVoidDelete200ResponseInvoicesInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "saleInvoice_Taskid__Void__delete_200_response_Invoices_inner")]
    public partial class SaleInvoiceTaskidVoidDelete200ResponseInvoicesInner(List<string> additionalCharges = default, string billingAddressLine1 = default, string billingAddressLine2 = default, bool combineAdditionalCharges = default, decimal currencyConversionRate = default, string invoiceDate = default, string invoiceDueDate = default, string invoiceNumber = default, List<string> lines = default, string linkedFulfillmentNumber = default, string memo = default, string status = default, string taskID = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SaleInvoiceTaskidVoidDelete200ResponseInvoicesInner {\n");
