...
namespace CIN7.DearInventory.Model
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="PurchasePutRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "purchase_put_request")]
    public partial class PurchasePutRequest(AdvancedPurchasePutRequestAdditionalAttributes additionalAttributes = default, string approach = default, AdvancedPurchasePutRequestBillingAddress billingAddress = default, bool blindReceipt = default, string contact = default, decimal currencyRate = default, string iD = default, string location = default, string note = default, string phone = default, object requiredBy = default, AdvancedPurchasePutRequestShippingAddress shippingAddress = default, string supplier = default, string supplierID = default, string taxCalculation = default, string taxRule = default, string terms = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchasePutRequest {\n");
