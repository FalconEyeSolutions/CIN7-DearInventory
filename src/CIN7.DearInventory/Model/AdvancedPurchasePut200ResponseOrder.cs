...
{
    /// <summary>
    /// AdvancedPurchasePut200ResponseOrder
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="AdvancedPurchasePut200ResponseOrder" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "advancedPurchase_put_200_response_Order")]
    public partial class AdvancedPurchasePut200ResponseOrder(List<string> additionalCharges = default, List<string> lines = default, string memo = default, List<string> prepayments = default, string status = default, decimal tax = default, decimal total = default, decimal totalBeforeTax = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchasePut200ResponseOrder {\n");
