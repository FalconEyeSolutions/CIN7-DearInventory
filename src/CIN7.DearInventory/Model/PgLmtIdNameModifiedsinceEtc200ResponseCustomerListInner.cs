...
{
    /// <summary>
    /// PgLmtIdNameModifiedsinceEtc200ResponseCustomerListInner
    /// </summary>
    [DataContract(Name = "Pg__Lmt__Id__Name__Modifiedsince__Etc_200_response_CustomerList_inner")]
    public partial class PgLmtIdNameModifiedsinceEtc200ResponseCustomerListInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PgLmtIdNameModifiedsinceEtc200ResponseCustomerListInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected PgLmtIdNameModifiedsinceEtc200ResponseCustomerListInner()
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="PgLmtIdNameModifiedsinceEtc200ResponseCustomerListInner" /> class.
        /// </summary>
        /// <param name="accountReceivable">accountReceivable (required).</param>
        ...
        /// <param name="isOnCreditHold">isOnCreditHold (required).</param>
        ...
        /// <param name="productPrices">productPrices.</param>
        /// <param name="revenueAccount">revenueAccount (required).</param>
        ...
        public PgLmtIdNameModifiedsinceEtc200ResponseCustomerListInner(string accountReceivable = default, string additionalAttribute1 = default, string additionalAttribute10 = default, string additionalAttribute2 = default, string additionalAttribute3 = default, string additionalAttribute4 = default, string additionalAttribute5 = default, string additionalAttribute6 = default, string additionalAttribute7 = default, string additionalAttribute8 = default, string additionalAttribute9 = default, List<CrmLeadPut200ResponseLeadListInnerAddressesInner> addresses = default, object attributeSet = default, string carrier = default, string comments = default, List<PgLmtIdNameModifiedsinceEtc200ResponseCustomerListInnerContactsInner> contacts = default, decimal creditLimit = default, string currency = default, decimal discount = default, string iD = default, bool isOnCreditHold = default, string lastModifiedOn = default, string location = default, string name = default, string paymentTerm = default, string priceTier = default, List<PgLmtIdNameModifiedsinceEtc200ResponseCustomerListInnerProductPricesInner> productPrices = default, string revenueAccount = default, object salesRepresentative = default, string status = default, string tags = default, string taxNumber = default, string taxRule = default)
        {
            // to ensure "accountReceivable" is required (not null)
            ArgumentNullException.ThrowIfNull(accountReceivable);
            ...
            PriceTier = priceTier;
            // to ensure "revenueAccount" is required (not null)
            ArgumentNullException.ThrowIfNull(revenueAccount);
        ...
        /// </summary>
        [DataMember(Name = "AccountReceivable", IsRequired = true, EmitDefaultValue = true)]
        ...
        public List<CrmLeadPut200ResponseLeadListInnerAddressesInner> Addresses { get; set; }
        ...
        public List<PgLmtIdNameModifiedsinceEtc200ResponseCustomerListInnerContactsInner> Contacts { get; set; }
        ...
        /// </summary>
        [DataMember(Name = "IsOnCreditHold", IsRequired = true, EmitDefaultValue = true)]
        ...
        public List<PgLmtIdNameModifiedsinceEtc200ResponseCustomerListInnerProductPricesInner> ProductPrices { get; set; }

        /// <summary>
        /// Gets or Sets RevenueAccount
        /// </summary>
        [DataMember(Name = "RevenueAccount", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PgLmtIdNameModifiedsinceEtc200ResponseCustomerListInner {\n");
