...
{
    /// <summary>
    /// AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInventoryMovementsInner
    /// </summary>
    [DataContract(Name = "advancedPurchase_Id__Combineadditionalcharges__get_200_response_InventoryMovements_inner")]
    public partial class AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInventoryMovementsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInventoryMovementsInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInventoryMovementsInner()
        { }
        ...
        public AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInventoryMovementsInner(decimal cOGS = default, string date = default, string dimensionsUnits = default, string productCustomField1 = default, string productCustomField10 = default, string productCustomField2 = default, string productCustomField3 = default, string productCustomField4 = default, string productCustomField5 = default, string productCustomField6 = default, string productCustomField7 = default, string productCustomField8 = default, string productCustomField9 = default, decimal productHeight = default, string productID = default, decimal productLength = default, decimal productWeight = default, decimal productWidth = default, string taskID = default, string weightUnits = default)
        {
            COGS = cOGS;
        ...
        /// Gets or Sets COGS
        /// </summary>
        [DataMember(Name = "COGS", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchaseIdCombineadditionalchargesGet200ResponseInventoryMovementsInner {\n");
