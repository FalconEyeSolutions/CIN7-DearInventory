...
{
    /// <summary>
    /// ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInner" /> class.
    /// </remarks>
    ...
    public partial class ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInner(List<string> attachments = default, List<ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInnerComponentsInner> components = default, decimal cycleTime = default, List<ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInnerFinishedProductsInner> finishedProducts = default, List<string> inputProducts = default, bool isDropShip = default, string name = default, List<string> notes = default, string operationID = default, List<ProductionProductionbomPutRequestOperationsInnerOperationLinksInner> operationLinks = default, string operationType = default, decimal order = default, List<string> outputProducts = default, List<ProductionProductionbomPutRequestOperationsInnerResourcesInner> resources = default, decimal unitsPerCycle = default, List<ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInnerVariationComponentsInner> variationComponents = default, object workCenterCoManProcurementType = default, string workCenterID = default, string workCenterName = default) : IValidatableObject
    {
        ...
        public List<ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInnerComponentsInner> Components { get; set; } = components;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInner {\n");
