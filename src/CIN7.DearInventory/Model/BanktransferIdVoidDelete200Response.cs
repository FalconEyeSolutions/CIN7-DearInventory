...
{
    /// <summary>
    /// BanktransferIdVoidDelete200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="BanktransferIdVoidDelete200Response" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "banktransfer_Id__Void__delete_200_response")]
    public partial class BanktransferIdVoidDelete200Response(List<string> attachments = default, decimal currencyConversionRate = default, string date = default, string fromAccount = default, decimal fromAmount = default, string note = default, string reference = default, string status = default, string taskID = default, string toAccount = default, decimal toAmount = default, List<string> transactions = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BanktransferIdVoidDelete200Response {\n");
