...
{
    /// <summary>
    /// FinishedgoodsPickTaskidGet200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="FinishedgoodsPickTaskidGet200Response" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "finishedgoodsPick_Taskid__get_200_response")]
    public partial class FinishedgoodsPickTaskidGet200Response(string account = default, string completionDate = default, List<FinishedgoodsPickPostRequestPickLinesInner> pickLines = default, string status = default, string taskID = default, string wIPAccount = default, string wIPDate = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FinishedgoodsPickTaskidGet200Response {\n");
