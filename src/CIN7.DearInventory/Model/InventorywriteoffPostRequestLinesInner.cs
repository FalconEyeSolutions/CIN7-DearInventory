...
{
    /// <summary>
    /// InventorywriteoffPostRequestLinesInner
    /// </summary>
    [DataContract(Name = "inventorywriteoff_post_request_Lines_inner")]
    public partial class InventorywriteoffPostRequestLinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventorywriteoffPostRequestLinesInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected InventorywriteoffPostRequestLinesInner()
        { }
        ...
        public InventorywriteoffPostRequestLinesInner(string batchSN = default, object bin = default, object binID = default, decimal cost = default, string expenseAccount = default, string expiryDate = default, string name = default, string productCode = default, string productID = default, decimal quantity = default)
        {
            ...
            ArgumentNullException.ThrowIfNull(binID);
            BinID = binID;
            Cost = cost;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InventorywriteoffPostRequestLinesInner {\n");
