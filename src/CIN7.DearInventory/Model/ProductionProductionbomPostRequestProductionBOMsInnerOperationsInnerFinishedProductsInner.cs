...
{
    /// <summary>
    /// ProductionProductionbomPostRequestProductionBOMsInnerOperationsInnerFinishedProductsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionProductionbomPostRequestProductionBOMsInnerOperationsInnerFinishedProductsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productionProductionbom_post_request_ProductionBOMs_inner_Operations_inner_FinishedProducts_inner")]
    public partial class ProductionProductionbomPostRequestProductionBOMsInnerOperationsInnerFinishedProductsInner(decimal averageCost = default, string costCalculationType = default, string costingMethod = default, object deliveryTo = default, object deliveryToName = default, decimal outputQuantity = default, decimal position = default, decimal priceTier = default, string productFamilyID = default, string productName = default, string productSKU = default, decimal ratio = default, string unit = default, decimal wastageCost = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionProductionbomPostRequestProductionBOMsInnerOperationsInnerFinishedProductsInner {\n");
