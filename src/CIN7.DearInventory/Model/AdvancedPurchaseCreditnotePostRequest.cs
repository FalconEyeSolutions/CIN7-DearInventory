...
namespace CIN7.DearInventory.Model
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="AdvancedPurchaseCreditnotePostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "advancedPurchaseCreditnote_post_request")]
    public partial class AdvancedPurchaseCreditnotePostRequest(List<AdvancedPurchaseCreditnotePostRequestAdditionalChargesInner> additionalCharges = default, bool combineAdditionalCharges = default, string creditNoteDate = default, string creditNoteInvoiceNumber = default, string creditNoteNumber = default, List<AdvancedPurchaseCreditnotePostRequestLinesInner> lines = default, string purchaseID = default, string status = default, string taskID = default, decimal tax = default, decimal total = default, decimal totalBeforeTax = default, List<AdvancedPurchaseCreditnotePostRequestUnstockInner> unstock = default) : IValidatableObject
    {
        /// <summary>
        ...
        public List<AdvancedPurchaseCreditnotePostRequestUnstockInner> Unstock { get; set; } = unstock;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchaseCreditnotePostRequest {\n");
