...
{
    /// <summary>
    /// SalePaymentSaleidGet200ResponseInner
    /// </summary>
    [DataContract(Name = "salePayment_Saleid__get_200_response_inner")]
    public partial class SalePaymentSaleidGet200ResponseInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalePaymentSaleidGet200ResponseInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected SalePaymentSaleidGet200ResponseInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SalePaymentSaleidGet200ResponseInner" /> class.
        /// </summary>
        ...
        /// <param name="currencyRate">currencyRate (required).</param>
        /// <param name="dateCreated">dateCreated (required).</param>
        /// <param name="datePaid">datePaid (required).</param>
        ...
        /// <param name="saleOrderNumber">saleOrderNumber (required).</param>
        /// <param name="taskID">taskID (required).</param>
        /// <param name="type">type (required).</param>
        public SalePaymentSaleidGet200ResponseInner(string account = default, decimal amount = default, object creditID = default, string creditNoteNumber = default, decimal currencyRate = default, string dateCreated = default, string datePaid = default, string iD = default, string invoiceNumber = default, string reference = default, string saleID = default, string saleOrderNumber = default, string taskID = default, string type = default)
        {
            ...
            // to ensure "datePaid" is required (not null)
            ArgumentNullException.ThrowIfNull(datePaid);
            DatePaid = datePaid;
            ...
            SaleID = saleID;
            // to ensure "saleOrderNumber" is required (not null)
            ArgumentNullException.ThrowIfNull(saleOrderNumber);
        ...
        public object CreditID { get; set; }
        ...
        /// </summary>
        [DataMember(Name = "CurrencyRate", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "DatePaid", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <summary>
        /// Gets or Sets SaleOrderNumber
        /// </summary>
        [DataMember(Name = "SaleOrderNumber", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalePaymentSaleidGet200ResponseInner {\n");
            ...
            sb.Append("  SaleOrderNumber: ").Append(SaleOrderNumber).Append('\n');
