...
{
    /// <summary>
    /// ProductfamilyPutRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductfamilyPutRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productfamily_put_request")]
    public partial class ProductfamilyPutRequest(object attributeSet = default, object brand = default, object cOGSAccount = default, string category = default, string costingMethod = default, string countryOfOrigin = default, string defaultLocation = default, string description = default, object discountRule = default, string dropShipMode = default, string hSCode = default, string iD = default, object inventoryAccount = default, decimal minimumBeforeReorder = default, string name = default, string option1Name = default, string option2Name = default, string option3Name = default, decimal priceTier1 = default, decimal priceTier10 = default, decimal priceTier2 = default, decimal priceTier3 = default, decimal priceTier4 = default, decimal priceTier5 = default, decimal priceTier6 = default, decimal priceTier7 = default, decimal priceTier8 = default, decimal priceTier9 = default, List<ProductfamilyPutRequestProductsInner> products = default, object purchaseTaxRule = default, decimal reorderQuantity = default, object revenueAccount = default, string sKU = default, object saleTaxRule = default, string shortDescription = default, string tags = default, string uOM = default) : IValidatableObject
    {
        /// <summary>
        ...
        public List<ProductfamilyPutRequestProductsInner> Products { get; set; } = products;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductfamilyPutRequest {\n");
