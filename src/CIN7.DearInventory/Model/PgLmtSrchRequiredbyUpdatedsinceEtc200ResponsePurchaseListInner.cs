...
{
    /// <summary>
    /// PgLmtSrchRequiredbyUpdatedsinceEtc200ResponsePurchaseListInner
    /// </summary>
    [DataContract(Name = "Pg__Lmt__Srch__Requiredby__Updatedsince__Etc_200_response_PurchaseList_inner")]
    public partial class PgLmtSrchRequiredbyUpdatedsinceEtc200ResponsePurchaseListInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PgLmtSrchRequiredbyUpdatedsinceEtc200ResponsePurchaseListInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected PgLmtSrchRequiredbyUpdatedsinceEtc200ResponsePurchaseListInner()
        { }
        ...
        public PgLmtSrchRequiredbyUpdatedsinceEtc200ResponsePurchaseListInner(string baseCurrency = default, bool blindReceipt = default, string combinedInvoiceStatus = default, string combinedPaymentStatus = default, string combinedReceivingStatus = default, string creditNoteNumber = default, string creditNoteStatus = default, string dropShipTaskID = default, string iD = default, decimal invoiceAmount = default, string invoiceDate = default, string invoiceDueDate = default, string invoiceNumber = default, string invoiceStatus = default, bool isServiceOnly = default, string lastUpdatedDate = default, string orderDate = default, string orderNumber = default, string orderStatus = default, decimal paidAmount = default, object requiredBy = default, string status = default, string stockReceivedStatus = default, string supplier = default, string supplierCurrency = default, string supplierID = default, string type = default, string unstockStatus = default)
        {
        ...
        public string DropShipTaskID { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PgLmtSrchRequiredbyUpdatedsinceEtc200ResponsePurchaseListInner {\n");
