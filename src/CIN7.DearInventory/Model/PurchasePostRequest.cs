...
namespace CIN7.DearInventory.Model
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="PurchasePostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "purchase_post_request")]
    public partial class PurchasePostRequest(AdvancedPurchasePutRequestAdditionalAttributes additionalAttributes = default, string approach = default, AdvancedPurchasePutRequestBillingAddress billingAddress = default, bool blindReceipt = default, string contact = default, decimal currencyRate = default, string location = default, string note = default, string phone = default, object requiredBy = default, AdvancedPurchasePutRequestShippingAddress shippingAddress = default, string supplier = default, string supplierID = default, string taxCalculation = default, string taxRule = default, string terms = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchasePostRequest {\n");
