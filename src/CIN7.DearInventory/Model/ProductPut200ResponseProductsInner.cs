...
{
    /// <summary>
    /// ProductPut200ResponseProductsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductPut200ResponseProductsInner" /> class.
    /// </remarks>
    ...
    public partial class ProductPut200ResponseProductsInner(string additionalAttribute1 = default, string additionalAttribute10 = default, string additionalAttribute2 = default, string additionalAttribute3 = default, string additionalAttribute4 = default, string additionalAttribute5 = default, string additionalAttribute6 = default, string additionalAttribute7 = default, string additionalAttribute8 = default, string additionalAttribute9 = default, string assemblyCostEstimationMethod = default, string assemblyInstructionURL = default, List<JournalPgLmtTaskidStsSrchGet200ResponseJournalsInnerAttachmentsInner> attachments = default, object attributeSet = default, bool autoAssembly = default, bool autoDisassembly = default, decimal averageCost = default, string barcode = default, bool billOfMaterial = default, List<ProductPutRequestBillOfMaterialsProductsInner> billOfMaterialsProducts = default, List<ProductPutRequestBillOfMaterialsServicesInner> billOfMaterialsServices = default, object brand = default, object cOGSAccount = default, decimal cartonHeight = default, decimal cartonInnerQuantity = default, decimal cartonLength = default, decimal cartonQuantity = default, decimal cartonWidth = default, string category = default, string costingMethod = default, string countryOfOrigin = default, string countryOfOriginCode = default, string defaultLocation = default, string description = default, object discountRule = default, string dropShipMode = default, object expenseAccount = default, string hSCode = default, decimal height = default, string iD = default, string internalNote = default, object inventoryAccount = default, string lastModifiedOn = default, decimal length = default, decimal minimumBeforeReorder = default, List<ProductPut200ResponseProductsInnerMovementsInner> movements = default, string name = default, string pickZones = default, decimal priceTier1 = default, decimal priceTier10 = default, decimal priceTier2 = default, decimal priceTier3 = default, decimal priceTier4 = default, decimal priceTier5 = default, decimal priceTier6 = default, decimal priceTier7 = default, decimal priceTier8 = default, decimal priceTier9 = default, ProductPutRequestPriceTiers priceTiers = default, object purchaseTaxRule = default, decimal quantityToProduce = default, List<ProductPutRequestReorderLevelsInner> reorderLevels = default, decimal reorderQuantity = default, object revenueAccount = default, string sKU = default, object saleTaxRule = default, bool sellable = default, string shortDescription = default, string status = default, string stockLocator = default, List<ProductPutRequestSuppliersInner> suppliers = default, string tags = default, string type = default, string uOM = default, decimal weight = default, decimal width = default) : IValidatableObject
    {
        ...
        public List<ProductPut200ResponseProductsInnerMovementsInner> Movements { get; set; } = movements;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductPut200ResponseProductsInner {\n");
