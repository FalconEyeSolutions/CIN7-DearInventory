...
{
    /// <summary>
    /// AdvancedPurchasePut200ResponseCreditNoteInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="AdvancedPurchasePut200ResponseCreditNoteInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "advancedPurchase_put_200_response_CreditNote_inner")]
    public partial class AdvancedPurchasePut200ResponseCreditNoteInner(List<string> additionalCharges = default, object creditNoteDate = default, string creditNoteInvoiceNumber = default, string creditNoteNumber = default, List<string> lines = default, List<string> refunds = default, string status = default, string taskID = default, decimal tax = default, decimal total = default, decimal totalBeforeTax = default, List<string> unstock = default) : IValidatableObject
    {
        /// <summary>
        ...
        public List<string> Unstock { get; set; } = unstock;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchasePut200ResponseCreditNoteInner {\n");
