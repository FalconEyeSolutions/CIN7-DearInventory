...
{
    /// <summary>
    /// SalePut200ResponseFulfilmentsInnerShipLinesInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="SalePut200ResponseFulfilmentsInnerShipLinesInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "sale_put_200_response_Fulfilments_inner_Ship_Lines_inner")]
    public partial class SalePut200ResponseFulfilmentsInnerShipLinesInner(string boxes = default, string carrier = default, string iD = default, bool isShipped = default, string shipmentDate = default, string trackingNumber = default, string trackingURL = default) : IValidatableObject
    {
        ...
        public string Boxes { get; set; } = boxes;
        ...
        public bool IsShipped { get; set; } = isShipped;

        /// <summary>
        /// Gets or Sets ShipmentDate
        /// </summary>
        [DataMember(Name = "ShipmentDate", EmitDefaultValue = false)]
        public string ShipmentDate { get; set; } = shipmentDate;
        ...
        public string TrackingURL { get; set; } = trackingURL;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalePut200ResponseFulfilmentsInnerShipLinesInner {\n");
