...
{
    /// <summary>
    /// SaleOrderPostRequestLinesInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="SaleOrderPostRequestLinesInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "saleOrder_post_request_Lines_inner")]
    public partial class SaleOrderPostRequestLinesInner(decimal averageCost = default, decimal backorderQuantity = default, string comment = default, decimal discount = default, bool dropShip = default, string name = default, decimal price = default, string productID = default, decimal quantity = default, string sKU = default, decimal tax = default, string taxRule = default, decimal total = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SaleOrderPostRequestLinesInner {\n");
