...
namespace CIN7.DearInventory.Model
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="Undo200Response" /> class.
    /// </remarks>
    /// <param name="message">message.</param>
    /// <param name="productionOrderID">productionOrderID.</param>
    [DataContract(Name = "Undo_200_response")]
    public partial class Undo200Response(string message = default, string productionOrderID = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Undo200Response {\n");
