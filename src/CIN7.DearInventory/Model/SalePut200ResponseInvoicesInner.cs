...
{
    /// <summary>
    /// SalePut200ResponseInvoicesInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="SalePut200ResponseInvoicesInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "sale_put_200_response_Invoices_inner")]
    public partial class SalePut200ResponseInvoicesInner(List<SalePut200ResponseCreditNotesInnerAdditionalChargesInner> additionalCharges = default, string billingAddressLine1 = default, string billingAddressLine2 = default, decimal currencyConversionRate = default, string invoiceDate = default, string invoiceDueDate = default, string invoiceNumber = default, List<SalePut200ResponseCreditNotesInnerLinesInner> lines = default, string linkedFulfillmentNumber = default, string memo = default, decimal paid = default, List<string> payments = default, string status = default, string taskID = default, decimal tax = default, decimal total = default, decimal totalBeforeTax = default) : IValidatableObject
    {
        ...
        public List<string> Payments { get; set; } = payments;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalePut200ResponseInvoicesInner {\n");
