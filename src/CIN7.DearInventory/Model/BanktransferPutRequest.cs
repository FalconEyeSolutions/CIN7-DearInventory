...
{
    /// <summary>
    /// BanktransferPutRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="BanktransferPutRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "banktransfer_put_request")]
    public partial class BanktransferPutRequest(string date = default, string fromAccount = default, decimal fromAmount = default, string note = default, string reference = default, string status = default, string taskID = default, string toAccount = default, decimal toAmount = default) : IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Date
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BanktransferPutRequest {\n");
