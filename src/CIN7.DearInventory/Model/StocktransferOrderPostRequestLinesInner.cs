...
{
    /// <summary>
    /// StocktransferOrderPostRequestLinesInner
    /// </summary>
    [DataContract(Name = "stocktransferOrder_post_request_Lines_inner")]
    public partial class StocktransferOrderPostRequestLinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StocktransferOrderPostRequestLinesInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected StocktransferOrderPostRequestLinesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StocktransferOrderPostRequestLinesInner" /> class.
        /// </summary>
        ...
        public StocktransferOrderPostRequestLinesInner(string comments = default, string productID = default, string productName = default, string sKU = default, decimal transferQuantity = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StocktransferOrderPostRequestLinesInner {\n");
