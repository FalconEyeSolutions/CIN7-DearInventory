...
{
    /// <summary>
    /// BanktransferPostRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="BanktransferPostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "banktransfer_post_request")]
    public partial class BanktransferPostRequest(string date = default, string fromAccount = default, decimal fromAmount = default, string note = default, string reference = default, string status = default, string toAccount = default, decimal toAmount = default) : IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Date
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BanktransferPostRequest {\n");
