...
{
    /// <summary>
    /// ProductPutRequestReorderLevelsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductPutRequestReorderLevelsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "product_put_request_ReorderLevels_inner")]
    public partial class ProductPutRequestReorderLevelsInner(string locationID = default, string locationName = default, decimal minimumBeforeReorder = default, string pickZones = default, decimal reorderQuantity = default, string stockLocator = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductPutRequestReorderLevelsInner {\n");
