...
namespace CIN7.DearInventory.Model
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="AdvancedPurchasePutRequestAdditionalAttributes" /> class.
    /// </remarks>
    ...
    public partial class AdvancedPurchasePutRequestAdditionalAttributes(string additionalAttribute1 = default, string additionalAttribute10 = default, string additionalAttribute2 = default, string additionalAttribute3 = default, string additionalAttribute4 = default, string additionalAttribute5 = default, string additionalAttribute6 = default, string additionalAttribute7 = default, string additionalAttribute8 = default, string additionalAttribute9 = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchasePutRequestAdditionalAttributes {\n");
