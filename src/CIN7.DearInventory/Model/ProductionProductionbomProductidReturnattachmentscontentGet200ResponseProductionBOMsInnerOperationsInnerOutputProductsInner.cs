...
{
    /// <summary>
    /// ProductionProductionbomProductidReturnattachmentscontentGet200ResponseProductionBOMsInnerOperationsInnerOutputProductsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionProductionbomProductidReturnattachmentscontentGet200ResponseProductionBOMsInnerOperationsInnerOutputProductsInner" /> class.
    /// </remarks>
    ...
    /// <param name="deliveryTo">deliveryTo.</param>
    ...
    [DataContract(Name = "productionProductionbom_Productid__Returnattachmentscontent__get_200_response_ProductionBOMs_inner_Operations_inner_OutputProducts_inner")]
    public partial class ProductionProductionbomProductidReturnattachmentscontentGet200ResponseProductionBOMsInnerOperationsInnerOutputProductsInner(decimal averageCost = default, string costCalculationType = default, string costingMethod = default, object deliveryTo = default, object deliveryToName = default, string iD = default, decimal outputQuantity = default, decimal position = default, decimal priceTier = default, object productFamilyID = default, string productID = default, string productName = default, string productSKU = default, decimal ratio = default, string unit = default, decimal wastageCost = default) : IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets DeliveryTo
        /// </summary>
        [DataMember(Name = "DeliveryTo", EmitDefaultValue = true)]
        public object DeliveryTo { get; set; } = deliveryTo;
        ...
        /// </summary>
        [DataMember(Name = "ProductFamilyID", EmitDefaultValue = true)]
        public object ProductFamilyID { get; set; } = productFamilyID;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionProductionbomProductidReturnattachmentscontentGet200ResponseProductionBOMsInnerOperationsInnerOutputProductsInner {\n");
