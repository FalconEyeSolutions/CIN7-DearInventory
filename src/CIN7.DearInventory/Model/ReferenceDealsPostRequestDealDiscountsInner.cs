...
{
    /// <summary>
    /// ReferenceDealsPostRequestDealDiscountsInner
    /// </summary>
    [DataContract(Name = "referenceDeals_post_request_DealDiscounts_inner")]
    public partial class ReferenceDealsPostRequestDealDiscountsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferenceDealsPostRequestDealDiscountsInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected ReferenceDealsPostRequestDealDiscountsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferenceDealsPostRequestDealDiscountsInner" /> class.
        /// </summary>
        ...
        public ReferenceDealsPostRequestDealDiscountsInner(bool buyMore = default, string buyType = default, object buyValue = default, string buyValueType = default, List<ReferenceDealsPostRequestDealDiscountsInnerDealDiscountBrandsInner> dealDiscountBrands = default, List<ReferenceDealsPostRequestDealDiscountsInnerDealDiscountCategoriesInner> dealDiscountCategories = default, List<ReferenceDealsPostRequestDealDiscountsInnerDealDiscountProductsInner> dealDiscountProducts = default, List<ReferenceDealsPostRequestDealDiscountsInnerDealDiscountTagsInner> dealDiscountTags = default, string discountID = default, string discountName = default, string discountType = default, string getType = default, object getValue = default, string getValueType = default, bool isOrderLevel = default, decimal sequence = default)
        {
            BuyMore = buyMore;
        ...
        public List<ReferenceDealsPostRequestDealDiscountsInnerDealDiscountBrandsInner> DealDiscountBrands { get; set; }

        /// <summary>
        /// Gets or Sets DealDiscountCategories
        /// </summary>
        [DataMember(Name = "DealDiscountCategories", IsRequired = true, EmitDefaultValue = true)]
        public List<ReferenceDealsPostRequestDealDiscountsInnerDealDiscountCategoriesInner> DealDiscountCategories { get; set; }

        /// <summary>
        /// Gets or Sets DealDiscountProducts
        /// </summary>
        [DataMember(Name = "DealDiscountProducts", IsRequired = true, EmitDefaultValue = true)]
        public List<ReferenceDealsPostRequestDealDiscountsInnerDealDiscountProductsInner> DealDiscountProducts { get; set; }

        /// <summary>
        /// Gets or Sets DealDiscountTags
        /// </summary>
        [DataMember(Name = "DealDiscountTags", IsRequired = true, EmitDefaultValue = true)]
        public List<ReferenceDealsPostRequestDealDiscountsInnerDealDiscountTagsInner> DealDiscountTags { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReferenceDealsPostRequestDealDiscountsInner {\n");
