...
{
    /// <summary>
    /// CompleteRun200ResponseRunsInnerOperationsInnerComponentsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="CompleteRun200ResponseRunsInnerOperationsInnerComponentsInner" /> class.
    /// </remarks>
    ...
    public partial class CompleteRun200ResponseRunsInnerOperationsInnerComponentsInner(decimal available = default, string batchSN = default, string costingMethod = default, decimal expectedQuantity = default, object expiryDate = default, bool isBackflush = default, bool isReserved = default, string locationID = default, string locationName = default, string productCode = default, decimal productCost = default, string productID = default, string productName = default, decimal quantity = default, decimal reservedQuantity = default, string runComponentID = default, string unit = default, decimal unitCost = default, decimal wastagePercent = default, decimal wastageQty = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompleteRun200ResponseRunsInnerOperationsInnerComponentsInner {\n");
