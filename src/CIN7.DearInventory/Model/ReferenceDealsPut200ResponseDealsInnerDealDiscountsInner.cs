...
{
    /// <summary>
    /// ReferenceDealsPut200ResponseDealsInnerDealDiscountsInner
    /// </summary>
    [DataContract(Name = "referenceDeals_put_200_response_Deals_inner_DealDiscounts_inner")]
    public partial class ReferenceDealsPut200ResponseDealsInnerDealDiscountsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferenceDealsPut200ResponseDealsInnerDealDiscountsInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected ReferenceDealsPut200ResponseDealsInnerDealDiscountsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferenceDealsPut200ResponseDealsInnerDealDiscountsInner" /> class.
        /// </summary>
        ...
        public ReferenceDealsPut200ResponseDealsInnerDealDiscountsInner(bool buyMore = default, string buyType = default, object buyValue = default, string buyValueType = default, List<string> dealDiscountBrands = default, List<string> dealDiscountCategories = default, List<ReferenceDealsPut200ResponseDealsInnerDealDiscountsInnerDealDiscountProductsInner> dealDiscountProducts = default, List<ReferenceDealsPut200ResponseDealsInnerDealDiscountsInnerDealDiscountTagsInner> dealDiscountTags = default, string discountID = default, string discountName = default, string discountType = default, string getType = default, object getValue = default, string getValueType = default, string iD = default, bool isOrderLevel = default, decimal sequence = default)
        {
            BuyMore = buyMore;
        ...
        public List<ReferenceDealsPut200ResponseDealsInnerDealDiscountsInnerDealDiscountProductsInner> DealDiscountProducts { get; set; }

        /// <summary>
        /// Gets or Sets DealDiscountTags
        /// </summary>
        [DataMember(Name = "DealDiscountTags", IsRequired = true, EmitDefaultValue = true)]
        public List<ReferenceDealsPut200ResponseDealsInnerDealDiscountsInnerDealDiscountTagsInner> DealDiscountTags { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReferenceDealsPut200ResponseDealsInnerDealDiscountsInner {\n");
