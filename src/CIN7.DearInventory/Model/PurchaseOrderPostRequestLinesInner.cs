...
{
    /// <summary>
    /// PurchaseOrderPostRequestLinesInner
    /// </summary>
    [DataContract(Name = "purchaseOrder_post_request_Lines_inner")]
    public partial class PurchaseOrderPostRequestLinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseOrderPostRequestLinesInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected PurchaseOrderPostRequestLinesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseOrderPostRequestLinesInner" /> class.
        /// </summary>
        ...
        public PurchaseOrderPostRequestLinesInner(string comment = default, decimal discount = default, string name = default, decimal price = default, string productID = default, decimal quantity = default, string sKU = default, string supplierSKU = default, decimal tax = default, string taxRule = default, decimal total = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseOrderPostRequestLinesInner {\n");
