...
{
    /// <summary>
    /// PurchaseStockPostRequestLinesInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="PurchaseStockPostRequestLinesInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "purchaseStock_post_request_Lines_inner")]
    public partial class PurchaseStockPostRequestLinesInner(string batchSN = default, string cardID = default, string date = default, string expiryDate = default, string location = default, string locationID = default, string name = default, string productID = default, decimal quantity = default, bool received = default, string sKU = default, string supplierSKU = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseStockPostRequestLinesInner {\n");
