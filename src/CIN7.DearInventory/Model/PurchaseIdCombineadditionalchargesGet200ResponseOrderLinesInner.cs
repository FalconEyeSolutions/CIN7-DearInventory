...
{
    /// <summary>
    /// PurchaseIdCombineadditionalchargesGet200ResponseOrderLinesInner
    /// </summary>
    [DataContract(Name = "purchase_Id__Combineadditionalcharges__get_200_response_Order_Lines_inner")]
    public partial class PurchaseIdCombineadditionalchargesGet200ResponseOrderLinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseIdCombineadditionalchargesGet200ResponseOrderLinesInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected PurchaseIdCombineadditionalchargesGet200ResponseOrderLinesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseIdCombineadditionalchargesGet200ResponseOrderLinesInner" /> class.
        /// </summary>
        ...
        /// <param name="supplierSKU">supplierSKU (required).</param>
        ...
        public PurchaseIdCombineadditionalchargesGet200ResponseOrderLinesInner(string comment = default, string dimensionsUnits = default, decimal discount = default, string name = default, decimal price = default, object productCustomField1 = default, object productCustomField10 = default, object productCustomField2 = default, object productCustomField3 = default, object productCustomField4 = default, object productCustomField5 = default, object productCustomField6 = default, object productCustomField7 = default, object productCustomField8 = default, object productCustomField9 = default, decimal productHeight = default, string productID = default, decimal productLength = default, decimal productWeight = default, decimal productWidth = default, decimal quantity = default, string sKU = default, string supplierSKU = default, decimal tax = default, string taxRule = default, decimal total = default, string weightUnits = default)
        {
            ...
            SKU = sKU;
            // to ensure "supplierSKU" is required (not null)
            ArgumentNullException.ThrowIfNull(supplierSKU);
        ...
        /// </summary>
        [DataMember(Name = "SupplierSKU", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseIdCombineadditionalchargesGet200ResponseOrderLinesInner {\n");
