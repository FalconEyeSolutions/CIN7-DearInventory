...
{
    /// <summary>
    /// AdvancedPurchaseCreditnotePostRequestUnstockInner
    /// </summary>
    [DataContract(Name = "advancedPurchaseCreditnote_post_request_Unstock_inner")]
    public partial class AdvancedPurchaseCreditnotePostRequestUnstockInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedPurchaseCreditnotePostRequestUnstockInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected AdvancedPurchaseCreditnotePostRequestUnstockInner()
        { }
        ...
        public AdvancedPurchaseCreditnotePostRequestUnstockInner(string batchSN = default, string cardID = default, string date = default, string expiryDate = default, string location = default, string name = default, string productID = default, decimal quantity = default, string sKU = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchaseCreditnotePostRequestUnstockInner {\n");
