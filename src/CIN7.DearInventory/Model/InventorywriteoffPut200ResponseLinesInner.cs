...
{
    /// <summary>
    /// InventorywriteoffPut200ResponseLinesInner
    /// </summary>
    [DataContract(Name = "inventorywriteoff_put_200_response_Lines_inner")]
    public partial class InventorywriteoffPut200ResponseLinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventorywriteoffPut200ResponseLinesInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected InventorywriteoffPut200ResponseLinesInner()
        { }
        ...
        public InventorywriteoffPut200ResponseLinesInner(string batchSN = default, string bin = default, string binID = default, decimal cost = default, string expenseAccount = default, string expiryDate = default, string name = default, string productCode = default, string productID = default, decimal quantity = default, decimal totalCost = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InventorywriteoffPut200ResponseLinesInner {\n");
