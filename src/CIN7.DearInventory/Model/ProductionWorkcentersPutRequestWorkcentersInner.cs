...
{
    /// <summary>
    /// ProductionWorkcentersPutRequestWorkcentersInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionWorkcentersPutRequestWorkcentersInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productionWorkcenters_put_request_Workcenters_inner")]
    public partial class ProductionWorkcentersPutRequestWorkcentersInner(string coManProcurementType = default, string code = default, bool isActive = default, bool isCoMan = default, bool isCoManPurchase = default, string name = default, string supplierID = default, string supplierName = default, string workCenterID = default, List<string> workCenterLocations = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionWorkcentersPutRequestWorkcentersInner {\n");
