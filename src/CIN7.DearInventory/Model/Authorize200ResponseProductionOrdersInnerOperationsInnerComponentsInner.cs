...
{
    /// <summary>
    /// Authorize200ResponseProductionOrdersInnerOperationsInnerComponentsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="Authorize200ResponseProductionOrdersInnerOperationsInnerComponentsInner" /> class.
    /// </remarks>
    /// <param name="available">available.</param>
    /// <param name="cost">cost.</param>
    /// <param name="costingMethod">costingMethod.</param>
    /// <param name="isAlternative">isAlternative.</param>
    /// <param name="isBackflush">isBackflush.</param>
    /// <param name="orderComponentID">orderComponentID.</param>
    ...
    [DataContract(Name = "Authorize_200_response_ProductionOrders_inner_Operations_inner_Components_inner")]
    public partial class Authorize200ResponseProductionOrdersInnerOperationsInnerComponentsInner(decimal available = default, decimal cost = default, string costingMethod = default, bool isAlternative = default, bool isBackflush = default, string orderComponentID = default, decimal position = default, decimal productCost = default, string productID = default, string productName = default, string productSKU = default, string productType = default, decimal quantity = default, decimal salePriceTier = default, decimal totalCost = default, decimal totalQuantity = default, string unit = default, decimal wastagePercent = default, decimal wastageQty = default) : IValidatableObject
    {
        /// <summary>
        ...
        public bool IsAlternative { get; set; } = isAlternative;
        ...
        /// </summary>
        [DataMember(Name = "OrderComponentID", EmitDefaultValue = false)]
        public string OrderComponentID { get; set; } = orderComponentID;
        ...
        public decimal TotalQuantity { get; set; } = totalQuantity;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Authorize200ResponseProductionOrdersInnerOperationsInnerComponentsInner {\n");
