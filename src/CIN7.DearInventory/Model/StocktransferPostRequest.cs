...
{
    /// <summary>
    /// StocktransferPostRequest
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="StocktransferPostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "stocktransfer_post_request")]
    public partial class StocktransferPostRequest(string completionDate = default, string costDistributionType = default, string departureDate = default, string from = default, string fromLocation = default, string inTransitAccount = default, List<StocktransferPutRequestLinesInner> lines = default, List<string> manualJournals = default, string reference = default, string requiredByDate = default, bool skipOrder = default, string status = default, string to = default, string toLocation = default) : IValidatableObject
    {
        ...
        public List<StocktransferPutRequestLinesInner> Lines { get; set; } = lines;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StocktransferPostRequest {\n");
