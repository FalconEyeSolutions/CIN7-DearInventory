...
{
    /// <summary>
    /// FinishedgoodslistPgLmtStsSrchSaleidGet200ResponseFinishedGoodsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="FinishedgoodslistPgLmtStsSrchSaleidGet200ResponseFinishedGoodsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "finishedgoodslist_Pg__Lmt__Sts__Srch__Saleid__get_200_response_FinishedGoods_inner")]
    public partial class FinishedgoodslistPgLmtStsSrchSaleidGet200ResponseFinishedGoodsInner(string assemblyNumber = default, string batchSN = default, string customField1 = default, string customField10 = default, string customField2 = default, string customField3 = default, string customField4 = default, string customField5 = default, string customField6 = default, string customField7 = default, string customField8 = default, string customField9 = default, string date = default, string expiryDate = default, string location = default, string locationID = default, string notes = default, string productCode = default, string productID = default, string productName = default, decimal quantity = default, string status = default, string taskID = default, decimal unitCost = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FinishedgoodslistPgLmtStsSrchSaleidGet200ResponseFinishedGoodsInner {\n");
