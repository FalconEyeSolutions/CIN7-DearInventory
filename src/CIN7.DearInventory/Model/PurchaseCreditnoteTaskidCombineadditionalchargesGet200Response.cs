...
{
    /// <summary>
    /// PurchaseCreditnoteTaskidCombineadditionalchargesGet200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="PurchaseCreditnoteTaskidCombineadditionalchargesGet200Response" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "purchaseCreditnote_Taskid__Combineadditionalcharges__get_200_response")]
    public partial class PurchaseCreditnoteTaskidCombineadditionalchargesGet200Response(List<AdvancedPurchaseCreditnotePostRequestAdditionalChargesInner> additionalCharges = default, bool combineAdditionalCharges = default, string creditNoteDate = default, string creditNoteNumber = default, List<AdvancedPurchaseCreditnotePostRequestLinesInner> lines = default, string status = default, string taskID = default, decimal tax = default, decimal total = default, decimal totalBeforeTax = default, List<PurchaseCreditnotePostRequestUnstockInner> unstock = default) : IValidatableObject
    {
        ...
        public List<PurchaseCreditnotePostRequestUnstockInner> Unstock { get; set; } = unstock;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseCreditnoteTaskidCombineadditionalchargesGet200Response {\n");
