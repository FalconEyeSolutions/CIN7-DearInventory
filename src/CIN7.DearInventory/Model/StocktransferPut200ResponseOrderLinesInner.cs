...
{
    /// <summary>
    /// StocktransferPut200ResponseOrderLinesInner
    /// </summary>
    [DataContract(Name = "stocktransfer_put_200_response_Order_Lines_inner")]
    public partial class StocktransferPut200ResponseOrderLinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StocktransferPut200ResponseOrderLinesInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected StocktransferPut200ResponseOrderLinesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StocktransferPut200ResponseOrderLinesInner" /> class.
        /// </summary>
        ...
        /// <param name="transferQuantity">transferQuantity (required).</param>
        /// <param name="weightUnits">weightUnits (required).</param>
        public StocktransferPut200ResponseOrderLinesInner(string comments = default, string dimensionsUnits = default, string productCustomField1 = default, string productCustomField10 = default, string productCustomField2 = default, string productCustomField3 = default, string productCustomField4 = default, string productCustomField5 = default, string productCustomField6 = default, string productCustomField7 = default, string productCustomField8 = default, string productCustomField9 = default, decimal productHeight = default, string productID = default, decimal productLength = default, string productName = default, decimal productWeight = default, decimal productWidth = default, decimal quantityAvailable = default, decimal quantityOnHand = default, string sKU = default, decimal transferQuantity = default, string weightUnits = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "TransferQuantity", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StocktransferPut200ResponseOrderLinesInner {\n");
