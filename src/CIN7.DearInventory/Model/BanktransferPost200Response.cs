...
{
    /// <summary>
    /// BanktransferPost200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="BanktransferPost200Response" /> class.
    /// </remarks>
    ...
    public partial class BanktransferPost200Response(List<string> attachments = default, decimal currencyConversionRate = default, string date = default, string fromAccount = default, decimal fromAmount = default, string note = default, string reference = default, string status = default, string taskID = default, string toAccount = default, decimal toAmount = default, List<string> transactions = default) : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BanktransferPost200Response {\n");
