...
{
    /// <summary>
    /// InventorywriteoffPutRequestLinesInner
    /// </summary>
    [DataContract(Name = "inventorywriteoff_put_request_Lines_inner")]
    public partial class InventorywriteoffPutRequestLinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventorywriteoffPutRequestLinesInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected InventorywriteoffPutRequestLinesInner()
        { }
        ...
        public InventorywriteoffPutRequestLinesInner(string batchSN = default, string bin = default, string binID = default, decimal cost = default, string expenseAccount = default, string expiryDate = default, string name = default, string productCode = default, string productID = default, decimal quantity = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InventorywriteoffPutRequestLinesInner {\n");
