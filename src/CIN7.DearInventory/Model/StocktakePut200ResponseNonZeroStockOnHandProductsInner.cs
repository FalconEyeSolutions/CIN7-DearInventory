...
{
    /// <summary>
    /// StocktakePut200ResponseNonZeroStockOnHandProductsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="StocktakePut200ResponseNonZeroStockOnHandProductsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "stocktake_put_200_response_NonZeroStockOnHandProducts_inner")]
    public partial class StocktakePut200ResponseNonZeroStockOnHandProductsInner(decimal adjustment = default, decimal available = default, string barcode = default, object batchSN = default, object comments = default, string costingMethod = default, string dimensionsUnits = default, object expiryDate = default, JournalPgLmtTaskidStsSrchGet200ResponseJournalsInnerAttachmentsInner image = default, string location = default, string locationID = default, string productCustomField1 = default, string productCustomField10 = default, string productCustomField2 = default, string productCustomField3 = default, string productCustomField4 = default, string productCustomField5 = default, string productCustomField6 = default, string productCustomField7 = default, string productCustomField8 = default, string productCustomField9 = default, decimal productHeight = default, string productID = default, decimal productLength = default, string productName = default, decimal productWeight = default, decimal productWidth = default, decimal quantityOnHand = default, string sKU = default, string stockLocator = default, string unit = default, string weightUnits = default) : IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "BatchSN", EmitDefaultValue = true)]
        public object BatchSN { get; set; } = batchSN;
        ...
        public object ExpiryDate { get; set; } = expiryDate;

        /// <summary>
        /// Gets or Sets Image
        /// </summary>
        [DataMember(Name = "Image", EmitDefaultValue = false)]
        public JournalPgLmtTaskidStsSrchGet200ResponseJournalsInnerAttachmentsInner Image { get; set; } = image;
        ...
        /// </summary>
        [DataMember(Name = "ProductCustomField1", EmitDefaultValue = false)]
        public string ProductCustomField1 { get; set; } = productCustomField1;

        /// <summary>
        /// Gets or Sets ProductCustomField10
        /// </summary>
        [DataMember(Name = "ProductCustomField10", EmitDefaultValue = false)]
        public string ProductCustomField10 { get; set; } = productCustomField10;

        /// <summary>
        /// Gets or Sets ProductCustomField2
        /// </summary>
        [DataMember(Name = "ProductCustomField2", EmitDefaultValue = false)]
        public string ProductCustomField2 { get; set; } = productCustomField2;

        /// <summary>
        /// Gets or Sets ProductCustomField3
        /// </summary>
        [DataMember(Name = "ProductCustomField3", EmitDefaultValue = false)]
        public string ProductCustomField3 { get; set; } = productCustomField3;

        /// <summary>
        /// Gets or Sets ProductCustomField4
        /// </summary>
        [DataMember(Name = "ProductCustomField4", EmitDefaultValue = false)]
        public string ProductCustomField4 { get; set; } = productCustomField4;

        /// <summary>
        /// Gets or Sets ProductCustomField5
        /// </summary>
        [DataMember(Name = "ProductCustomField5", EmitDefaultValue = false)]
        public string ProductCustomField5 { get; set; } = productCustomField5;

        /// <summary>
        /// Gets or Sets ProductCustomField6
        /// </summary>
        [DataMember(Name = "ProductCustomField6", EmitDefaultValue = false)]
        public string ProductCustomField6 { get; set; } = productCustomField6;

        /// <summary>
        /// Gets or Sets ProductCustomField7
        /// </summary>
        [DataMember(Name = "ProductCustomField7", EmitDefaultValue = false)]
        public string ProductCustomField7 { get; set; } = productCustomField7;

        /// <summary>
        /// Gets or Sets ProductCustomField8
        /// </summary>
        [DataMember(Name = "ProductCustomField8", EmitDefaultValue = false)]
        public string ProductCustomField8 { get; set; } = productCustomField8;

        /// <summary>
        /// Gets or Sets ProductCustomField9
        /// </summary>
        [DataMember(Name = "ProductCustomField9", EmitDefaultValue = false)]
        public string ProductCustomField9 { get; set; } = productCustomField9;
        ...
        public decimal QuantityOnHand { get; set; } = quantityOnHand;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StocktakePut200ResponseNonZeroStockOnHandProductsInner {\n");
