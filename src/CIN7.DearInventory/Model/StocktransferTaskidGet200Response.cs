...
{
    /// <summary>
    /// StocktransferTaskidGet200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="StocktransferTaskidGet200Response" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "stocktransfer_Taskid__get_200_response")]
    public partial class StocktransferTaskidGet200Response(string completionDate = default, string costDistributionType = default, string departureDate = default, string from = default, string fromLocation = default, string inTransitAccount = default, List<StocktransferPut200ResponseLinesInner> lines = default, List<string> manualJournals = default, string number = default, StocktransferPut200ResponseOrder order = default, string reference = default, string requiredByDate = default, bool skipOrder = default, string status = default, string taskID = default, string to = default, string toLocation = default) : IValidatableObject
    {
        ...
        public List<StocktransferPut200ResponseLinesInner> Lines { get; set; } = lines;
        ...
        public StocktransferPut200ResponseOrder Order { get; set; } = order;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StocktransferTaskidGet200Response {\n");
