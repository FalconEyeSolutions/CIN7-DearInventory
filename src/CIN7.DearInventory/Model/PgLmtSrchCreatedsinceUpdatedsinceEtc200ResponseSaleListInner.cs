...
{
    /// <summary>
    /// PgLmtSrchCreatedsinceUpdatedsinceEtc200ResponseSaleListInner
    /// </summary>
    [DataContract(Name = "Pg__Lmt__Srch__Createdsince__Updatedsince__Etc_200_response_SaleList_inner")]
    public partial class PgLmtSrchCreatedsinceUpdatedsinceEtc200ResponseSaleListInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PgLmtSrchCreatedsinceUpdatedsinceEtc200ResponseSaleListInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected PgLmtSrchCreatedsinceUpdatedsinceEtc200ResponseSaleListInner()
        { }
        ...
        /// <param name="restockStatus">restockStatus (required).</param>
        ...
        public PgLmtSrchCreatedsinceUpdatedsinceEtc200ResponseSaleListInner(string baseCurrency = default, string combinedInvoiceStatus = default, string combinedPackingStatus = default, string combinedPaymentStatus = default, string combinedPickingStatus = default, string combinedShippingStatus = default, string combinedTrackingNumbers = default, string creditNoteNumber = default, string creditNoteStatus = default, string customer = default, string customerCurrency = default, string customerID = default, string customerReference = default, string externalID = default, string fulFilmentStatus = default, decimal invoiceAmount = default, string invoiceDate = default, string invoiceDueDate = default, string invoiceNumber = default, string orderDate = default, string orderLocationID = default, string orderNumber = default, string orderStatus = default, decimal paidAmount = default, string quoteStatus = default, string restockStatus = default, string saleID = default, object shipBy = default, string sourceChannel = default, string status = default, string type = default, string updated = default)
        {
            ...
            // to ensure "restockStatus" is required (not null)
            ArgumentNullException.ThrowIfNull(restockStatus);
        ...
        /// <summary>
        /// Gets or Sets RestockStatus
        /// </summary>
        [DataMember(Name = "RestockStatus", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PgLmtSrchCreatedsinceUpdatedsinceEtc200ResponseSaleListInner {\n");
            ...
            sb.Append("  RestockStatus: ").Append(RestockStatus).Append('\n');
