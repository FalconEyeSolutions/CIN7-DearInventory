...
{
    /// <summary>
    /// CompleteRunOperation200ResponseRunsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="CompleteRunOperation200ResponseRunsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "Complete_Run_Operation_200_response_Runs_inner")]
    public partial class CompleteRunOperation200ResponseRunsInner(object dueDate = default, string endDate = default, decimal issueMethodParameter = default, List<string> manualJournals = default, decimal number = default, List<CompleteRunOperation200ResponseRunsInnerOperationsInner> operations = default, List<string> output = default, List<string> pendingOutput = default, decimal quantity = default, string receivedDate = default, string runID = default, string startDate = default, string status = default, string wIPAccount = default) : IValidatableObject
    {
        /// <summary>
        ...
        public List<CompleteRunOperation200ResponseRunsInnerOperationsInner> Operations { get; set; } = operations;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompleteRunOperation200ResponseRunsInner {\n");
