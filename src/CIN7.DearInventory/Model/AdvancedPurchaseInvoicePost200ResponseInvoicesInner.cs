...
{
    /// <summary>
    /// AdvancedPurchaseInvoicePost200ResponseInvoicesInner
    /// </summary>
    [DataContract(Name = "advancedPurchaseInvoice_post_200_response_Invoices_inner")]
    public partial class AdvancedPurchaseInvoicePost200ResponseInvoicesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedPurchaseInvoicePost200ResponseInvoicesInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected AdvancedPurchaseInvoicePost200ResponseInvoicesInner()
        { }
        ...
        /// <param name="invoiceTotalAmount">invoiceTotalAmount (required).</param>
        /// <param name="invoiceTotalTaxAmount">invoiceTotalTaxAmount (required).</param>
        ...
        public AdvancedPurchaseInvoicePost200ResponseInvoicesInner(List<string> additionalCharges = default, bool combineAdditionalCharges = default, string invoiceDate = default, string invoiceDueDate = default, string invoiceNumber = default, decimal invoiceTotalAmount = default, decimal invoiceTotalTaxAmount = default, List<AdvancedPurchaseCreditnotePostRequestLinesInner> lines = default, string status = default, string taskID = default, decimal tax = default, decimal total = default, decimal totalBeforeTax = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "InvoiceTotalAmount", IsRequired = true, EmitDefaultValue = true)]
        public decimal InvoiceTotalAmount { get; set; }

        /// <summary>
        /// Gets or Sets InvoiceTotalTaxAmount
        /// </summary>
        [DataMember(Name = "InvoiceTotalTaxAmount", IsRequired = true, EmitDefaultValue = true)]
        public decimal InvoiceTotalTaxAmount { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchaseInvoicePost200ResponseInvoicesInner {\n");
