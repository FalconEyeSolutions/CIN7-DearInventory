...
{
    /// <summary>
    /// ProductionProductionbomPut200ResponseProductionBOMsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionProductionbomPut200ResponseProductionBOMsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productionProductionbom_put_200_response_ProductionBOMs_inner")]
    public partial class ProductionProductionbomPut200ResponseProductionBOMsInner(string bOMID = default, decimal bufferPercent = default, decimal componentProductionLeadTime = default, string createdDate = default, object deliveryToID = default, object deliveryToName = default, bool ignoreCumulativeLeadTime = default, string instructionUrl = default, bool isDefault = default, decimal issueMethod = default, string name = default, List<ProductionProductionbomPut200ResponseProductionBOMsInnerOperationsInner> operations = default, decimal outputQuantity = default, decimal varVersion = default) : IValidatableObject
    {
        ...
        public List<ProductionProductionbomPut200ResponseProductionBOMsInnerOperationsInner> Operations { get; set; } = operations;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionProductionbomPut200ResponseProductionBOMsInner {\n");
