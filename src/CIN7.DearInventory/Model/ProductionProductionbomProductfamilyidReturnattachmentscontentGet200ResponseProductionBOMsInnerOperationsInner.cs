...
{
    /// <summary>
    /// ProductionProductionbomProductfamilyidReturnattachmentscontentGet200ResponseProductionBOMsInnerOperationsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ProductionProductionbomProductfamilyidReturnattachmentscontentGet200ResponseProductionBOMsInnerOperationsInner" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "productionProductionbom_Productfamilyid__Returnattachmentscontent__get_200_response_ProductionBOMs_inner_Operations_inner")]
    public partial class ProductionProductionbomProductfamilyidReturnattachmentscontentGet200ResponseProductionBOMsInnerOperationsInner(List<string> attachments = default, List<string> components = default, decimal cycleTime = default, List<ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInnerFinishedProductsInner> finishedProducts = default, List<string> inputProducts = default, bool isDropShip = default, string name = default, List<string> notes = default, string operationID = default, List<ProductionProductionbomPutRequestOperationsInnerOperationLinksInner> operationLinks = default, string operationType = default, decimal order = default, List<string> outputProducts = default, List<ProductionProductionbomPutRequestOperationsInnerResourcesInner> resources = default, decimal unitsPerCycle = default, List<ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInnerVariationComponentsInner> variationComponents = default, object workCenterCoManProcurementType = default, string workCenterID = default, string workCenterName = default) : IValidatableObject
    {
        ...
        public List<ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInnerFinishedProductsInner> FinishedProducts { get; set; } = finishedProducts;
        ...
        public List<ProductionProductionbomPost200ResponseProductionBOMsInnerOperationsInnerVariationComponentsInner> VariationComponents { get; set; } = variationComponents;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionProductionbomProductfamilyidReturnattachmentscontentGet200ResponseProductionBOMsInnerOperationsInner {\n");
