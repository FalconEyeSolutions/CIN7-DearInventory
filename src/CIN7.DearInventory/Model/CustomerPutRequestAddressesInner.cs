...
{
    /// <summary>
    /// CustomerPutRequestAddressesInner
    /// </summary>
    [DataContract(Name = "customer_put_request_Addresses_inner")]
    public partial class CustomerPutRequestAddressesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerPutRequestAddressesInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected CustomerPutRequestAddressesInner()
        { }
        ...
        public CustomerPutRequestAddressesInner(string city = default, string country = default, string customerID = default, bool defaultForType = default, string iD = default, string line1 = default, string line2 = default, string postcode = default, string state = default, string type = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomerPutRequestAddressesInner {\n");
