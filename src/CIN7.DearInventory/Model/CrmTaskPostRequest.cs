...
namespace CIN7.DearInventory.Model
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="CrmTaskPostRequest" /> class.
    /// </remarks>
    ...
    [DataContract(Name = "crmTask_post_request")]
    public partial class CrmTaskPostRequest(string assignedBy = default, string assignedTo = default, string category = default, object completedDate = default, object description = default, string endDate = default, string entityID = default, string entityType = default, bool isAllDay = default, bool isImportant = default, string name = default, string startDate = default, string taskStatus = default, object voidDate = default, object workflowName = default) : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrmTaskPostRequest {\n");
