...
{
    /// <summary>
    /// ResumeRunOperation200ResponseRunsInnerOperationsInnerComponentsInner
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="ResumeRunOperation200ResponseRunsInnerOperationsInnerComponentsInner" /> class.
    /// </remarks>
    /// <param name="available">available.</param>
    /// <param name="batchSN">batchSN.</param>
    /// <param name="costingMethod">costingMethod.</param>
    /// <param name="expectedQuantity">expectedQuantity.</param>
    ...
    /// <param name="productCost">productCost.</param>
    /// <param name="productID">productID.</param>
    /// <param name="productName">productName.</param>
    /// <param name="quantity">quantity.</param>
    /// <param name="reservedQuantity">reservedQuantity.</param>
    /// <param name="runComponentID">runComponentID.</param>
    ...
    [DataContract(Name = "Resume_Run_Operation_200_response_Runs_inner_Operations_inner_Components_inner")]
    public partial class ResumeRunOperation200ResponseRunsInnerOperationsInnerComponentsInner(decimal available = default, string batchSN = default, object costingMethod = default, decimal expectedQuantity = default, object expiryDate = default, bool isBackflush = default, bool isReserved = default, string locationID = default, string locationName = default, string productCode = default, decimal productCost = default, string productID = default, string productName = default, decimal quantity = default, decimal reservedQuantity = default, string runComponentID = default, string unit = default, decimal unitCost = default, decimal wastagePercent = default, decimal wastageQty = default) : IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "CostingMethod", EmitDefaultValue = true)]
        public object CostingMethod { get; set; } = costingMethod;

        /// <summary>
        /// Gets or Sets ExpectedQuantity
        /// </summary>
        [DataMember(Name = "ExpectedQuantity", EmitDefaultValue = false)]
        public decimal ExpectedQuantity { get; set; } = expectedQuantity;
        ...
        /// </summary>
        [DataMember(Name = "ProductCost", EmitDefaultValue = false)]
        public decimal ProductCost { get; set; } = productCost;
        ...
        /// </summary>
        [DataMember(Name = "RunComponentID", EmitDefaultValue = false)]
        public string RunComponentID { get; set; } = runComponentID;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResumeRunOperation200ResponseRunsInnerOperationsInnerComponentsInner {\n");
