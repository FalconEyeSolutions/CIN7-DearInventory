...
{
    /// <summary>
    /// AdvancedPurchaseCreditnotePostRequestLinesInner
    /// </summary>
    [DataContract(Name = "advancedPurchaseCreditnote_post_request_Lines_inner")]
    public partial class AdvancedPurchaseCreditnotePostRequestLinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedPurchaseCreditnotePostRequestLinesInner" /> class.
        /// </summary>
        [JsonConstructor]
        protected AdvancedPurchaseCreditnotePostRequestLinesInner()
        { }
        ...
        public AdvancedPurchaseCreditnotePostRequestLinesInner(string account = default, string comment = default, decimal discount = default, string name = default, decimal price = default, string productID = default, decimal quantity = default, string sKU = default, decimal tax = default, string taxRule = default, decimal total = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedPurchaseCreditnotePostRequestLinesInner {\n");
