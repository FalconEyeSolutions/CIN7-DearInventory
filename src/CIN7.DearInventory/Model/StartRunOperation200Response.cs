...
{
    /// <summary>
    /// StartRunOperation200Response
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="StartRunOperation200Response" /> class.
    /// </remarks>
    /// <param name="orderNumber">orderNumber.</param>
    /// <param name="productionOrderID">productionOrderID.</param>
    /// <param name="runs">runs.</param>
    /// <param name="warnings">warnings.</param>
    [DataContract(Name = "Start_Run_Operation_200_response")]
    public partial class StartRunOperation200Response(string orderNumber = default, string productionOrderID = default, List<StartRunOperation200ResponseRunsInner> runs = default, List<string> warnings = default) : IValidatableObject
    {
        ...
        public List<StartRunOperation200ResponseRunsInner> Runs { get; set; } = runs;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StartRunOperation200Response {\n");
