...
namespace CIN7.DearInventory.Test.Api
{
    ...
    public class TemplatesApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test RefTemplatesPgLmtTypeNameGet
        /// </summary>
        [Fact]
        public void RefTemplatesPgLmtTypeNameGetTest()
        {
            ...
            //var response = instance.RefTemplatesPgLmtTypeNameGet(page, limit, type, name, apiAuthAccountid, apiAuthApplicationkey);
            //Assert.IsType<RefTemplatesPgLmtTypeNameGet200Response>(response);
        }
    }
}
