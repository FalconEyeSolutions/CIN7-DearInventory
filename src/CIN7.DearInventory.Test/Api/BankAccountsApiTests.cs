...
namespace CIN7.DearInventory.Test.Api
{
    ...
    public class BankAccountsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test AccountBankPgLmtIdEtc
        /// </summary>
        [Fact]
        public void AccountBankPgLmtIdEtcTest()
        {
            ...
            //var response = instance.AccountBankPgLmtIdEtc(page, limit, ID, name, bank, apiAuthAccountid, apiAuthApplicationkey);
            //Assert.IsType<AccountBankPgLmtIdEtc200Response>(response);
        }
    }
}
