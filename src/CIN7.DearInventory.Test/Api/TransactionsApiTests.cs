...
namespace CIN7.DearInventory.Test.Api
{
    ...
    public class TransactionsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test TransactionsPgLmtFromdateTodateAccountGet
        /// </summary>
        [Fact]
        public void TransactionsPgLmtFromdateTodateAccountGetTest()
        {
            ...
            //var response = instance.TransactionsPgLmtFromdateTodateAccountGet(page, limit, fromDate, toDate, account, apiAuthAccountid, apiAuthApplicationkey);
            //Assert.IsType<TransactionsPgLmtFromdateTodateAccountGet200Response>(response);
        }
    }
}
